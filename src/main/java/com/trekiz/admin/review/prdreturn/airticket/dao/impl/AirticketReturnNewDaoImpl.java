package com.trekiz.admin.review.prdreturn.airticket.dao.impl;
...
@Repository
public class AirticketReturnNewDaoImpl extends BaseDaoImpl<Map<String, Object>>
		implements IAirticketReturnNewDao {
	...
	public Map<String, Object> queryAirTicketReturnDetailInfoById(String orderId) {
		...
		String airTicketReturnDetailSql = "SELECT a.id, a.create_by,"
				...
				+ "b.settlementcChildPrice, b.settlementSpecialPrice,b.currency_id currid,b.freePosition,"
