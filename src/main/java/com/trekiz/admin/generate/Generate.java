...
import com.trekiz.admin.common.utils.FreeMarkers;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.trekiz.admin.modules";
		
		String moduleName = "factory";			// 模块名
		String subModuleName = "";				// 子模块名（可选） 
		String className = "product";			// 类名
		String classAuthor = "zj";		// 类作者
		String functionName = "产品";			// 功能名
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/trekiz/admin/generate/template", "/", separator);
