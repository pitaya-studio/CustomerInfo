...
public class HotelQuoteConditionInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelQuoteCondition dataObj ;
	
	public HotelQuoteConditionInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelQuoteConditionInput(HotelQuoteCondition obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelQuoteCondition getHotelQuoteCondition() {
		dataObj = new HotelQuoteCondition();
