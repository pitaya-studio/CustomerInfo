...
public class HotelQuoteResultDetailPriceInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelQuoteResultDetailPrice dataObj ;
	
	public HotelQuoteResultDetailPriceInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelQuoteResultDetailPriceInput(HotelQuoteResultDetailPrice obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelQuoteResultDetailPrice getHotelQuoteResultDetailPrice() {
		dataObj = new HotelQuoteResultDetailPrice();
