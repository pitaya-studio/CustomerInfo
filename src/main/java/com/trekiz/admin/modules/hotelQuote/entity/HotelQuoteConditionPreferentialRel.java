...
@Entity
@Table(name = "hotel_quote_condition_preferential_rel")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelQuoteConditionPreferentialRel   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelQuoteConditionPreferentialRel";
	...
	public static final String ALIAS_HOTEL_PL_PREFERENTIAL_UUID = "关联原酒店优惠信息的UUID";
	public static final String ALIAS_HOTEL_QUOTE_PREFERENTIAL_UUID = "关联新报价优惠信息UUID";
	...
	public HotelQuoteConditionPreferentialRel(){
	}
