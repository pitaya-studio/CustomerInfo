...
public class HotelQuoteConditionDetailPersonNumInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelQuoteConditionDetailPersonNum dataObj ;
	
	public HotelQuoteConditionDetailPersonNumInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelQuoteConditionDetailPersonNumInput(HotelQuoteConditionDetailPersonNum obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelQuoteConditionDetailPersonNum getHotelQuoteConditionDetailPersonNum() {
		dataObj = new HotelQuoteConditionDetailPersonNum();
