...
public class HotelQuoteResultDetailInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelQuoteResultDetail dataObj ;
	
	public HotelQuoteResultDetailInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelQuoteResultDetailInput(HotelQuoteResultDetail obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelQuoteResultDetail getHotelQuoteResultDetail() {
		dataObj = new HotelQuoteResultDetail();
