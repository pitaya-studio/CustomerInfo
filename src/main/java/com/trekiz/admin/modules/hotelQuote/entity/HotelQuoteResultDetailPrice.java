...
@Entity
@Table(name = "hotel_quote_result_detail_price")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelQuoteResultDetailPrice   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelQuoteResultDetailPrice";
	...
	public HotelQuoteResultDetailPrice(){
	}
	...
	@Column(name="hotel_quote_result_uuid")
