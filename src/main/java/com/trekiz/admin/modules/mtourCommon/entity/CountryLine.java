...
@Entity
@Table(name = "country_line")
@DynamicInsert(true)
@DynamicUpdate(true)
public class CountryLine   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "CountryLine";
	public static final String ALIAS_ID = "主键";
	public static final String ALIAS_UUID = "uuid";
	public static final String ALIAS_COUNTRY_UUID = "线路国家uuid";
	public static final String ALIAS_COUNTRY_NAME = "线路国家名称";
	public static final String ALIAS_COUNTRY_SHORT = "国家简称";
