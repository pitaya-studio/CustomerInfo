...
public class ActivityIslandGroupRoomInput {
	...
	//columns END
	private ActivityIslandGroupRoom dataObj ;
	
	public ActivityIslandGroupRoomInput(){
	}
	//数据库映射bean转换成表单提交bean
	public ActivityIslandGroupRoomInput(ActivityIslandGroupRoom obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public ActivityIslandGroupRoom getActivityIslandGroupRoom() {
		dataObj = new ActivityIslandGroupRoom();
