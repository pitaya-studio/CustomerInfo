...
@Entity
@Table(name = "island_order_controlDetail")
@DynamicInsert(true)
@DynamicUpdate(true)
public class IslandOrderControlDetail   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "IslandOrderControlDetail";
	...
	public IslandOrderControlDetail(){
	}
