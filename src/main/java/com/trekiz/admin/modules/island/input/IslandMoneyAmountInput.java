...
public class IslandMoneyAmountInput  extends BaseInput {
	//自定义拆分规则定义
	...
	public IslandMoneyAmountInput(){
	}
	//数据库映射bean转换成表单提交bean
	public IslandMoneyAmountInput(IslandMoneyAmount obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public IslandMoneyAmount getIslandMoneyAmount() {
		dataObj = new IslandMoneyAmount();
