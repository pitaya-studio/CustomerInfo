...
public class ActivityIslandGroupAirlineInput  extends BaseInput {
	//自定义拆分规则定义
	...
	public ActivityIslandGroupAirlineInput(){
	}
	//数据库映射bean转换成表单提交bean
	public ActivityIslandGroupAirlineInput(ActivityIslandGroupAirline obj ){
	...
	public ActivityIslandGroupAirline getActivityIslandGroupAirline() {
		dataObj = new ActivityIslandGroupAirline();
