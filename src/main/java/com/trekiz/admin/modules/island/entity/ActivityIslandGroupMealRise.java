...
@Entity
@Table(name = "activity_island_group_meal_rise")
@DynamicInsert(true)
@DynamicUpdate(true)
public class ActivityIslandGroupMealRise   extends BaseEntity {
	...
	public ActivityIslandGroupMealRise(){
	}
	...
	public void setActivityIslandGroupMealUuid(java.lang.String value) {
		this.activityIslandGroupMealUuid = value;
	}
	@Column(name="activity_island_group_meal_uuid")
	public java.lang.String getActivityIslandGroupMealUuid() {
		return this.activityIslandGroupMealUuid;
	}
