...
@Entity
@Table(name = "island_traveler_papers_type")
@DynamicInsert(true)
@DynamicUpdate(true)
public class IslandTravelerPapersType   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "IslandTravelerPapersType";
	public static final String ALIAS_ID = "主键";
	public static final String ALIAS_UUID = "UUID";
	public static final String ALIAS_ISLAND_TRAVELER_UUID = "海岛游游客uuid";
	...
	public IslandTravelerPapersType(){
	}
