...
public class HotelPlPreferentialRelHotelInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlPreferentialRelHotel dataObj ;
	
	public HotelPlPreferentialRelHotelInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlPreferentialRelHotelInput(HotelPlPreferentialRelHotel obj ){
	...
	public HotelPlPreferentialRelHotel getHotelPlPreferentialRelHotel() {
		dataObj = new HotelPlPreferentialRelHotel();
