...
@Entity
@Table(name = "hotel_pl_islandway_memo")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelPlIslandwayMemo   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelPlIslandwayMemo";
