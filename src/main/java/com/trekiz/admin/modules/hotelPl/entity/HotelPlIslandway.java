...
@Entity
@Table(name = "hotel_pl_islandway")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelPlIslandway   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelPlIslandway";
