...
public class HotelPlRisemealMemoInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlRisemealMemo dataObj ;
	
	public HotelPlRisemealMemoInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlRisemealMemoInput(HotelPlRisemealMemo obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelPlRisemealMemo getHotelPlRisemealMemo() {
		dataObj = new HotelPlRisemealMemo();
