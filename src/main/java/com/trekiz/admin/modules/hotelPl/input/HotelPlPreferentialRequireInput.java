...
public class HotelPlPreferentialRequireInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlPreferentialRequire dataObj ;
	
	public HotelPlPreferentialRequireInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlPreferentialRequireInput(HotelPlPreferentialRequire obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelPlPreferentialRequire getHotelPlPreferentialRequire() {
		dataObj = new HotelPlPreferentialRequire();
