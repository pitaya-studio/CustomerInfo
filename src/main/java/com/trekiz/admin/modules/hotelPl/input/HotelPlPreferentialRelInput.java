...
public class HotelPlPreferentialRelInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlPreferentialRel dataObj ;
	
	public HotelPlPreferentialRelInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlPreferentialRelInput(HotelPlPreferentialRel obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelPlPreferentialRel getHotelPlPreferentialRel() {
		dataObj = new HotelPlPreferentialRel();
