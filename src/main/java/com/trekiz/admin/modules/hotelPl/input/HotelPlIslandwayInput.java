...
public class HotelPlIslandwayInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlIslandway dataObj ;
	
	public HotelPlIslandwayInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlIslandwayInput(HotelPlIslandway obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelPlIslandway getHotelPlIslandway() {
		dataObj = new HotelPlIslandway();
