...
@Entity
@Table(name = "hotel_pl_risemeal_memo")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelPlRisemealMemo   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelPlRisemealMemo";
	...
	public static final String ALIAS_HOTEL_MEAL_UUID = "酒店餐型uuid（数据源是酒店房型餐型关联表读取）";
