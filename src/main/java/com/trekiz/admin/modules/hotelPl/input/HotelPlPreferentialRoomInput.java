...
public class HotelPlPreferentialRoomInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlPreferentialRoom dataObj ;
	
	public HotelPlPreferentialRoomInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlPreferentialRoomInput(HotelPlPreferentialRoom obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelPlPreferentialRoom getHotelPlPreferentialRoom() {
		dataObj = new HotelPlPreferentialRoom();
