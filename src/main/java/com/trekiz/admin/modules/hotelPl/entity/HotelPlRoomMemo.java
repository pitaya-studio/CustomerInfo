...
@Entity
@Table(name = "hotel_pl_room_memo")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelPlRoomMemo   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelPlRoomMemo";
	...
	public static final String ALIAS_HOTEL_ROOM_ID = "房型uuid";
