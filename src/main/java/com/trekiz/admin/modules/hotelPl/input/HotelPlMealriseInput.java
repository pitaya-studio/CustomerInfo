...
public class HotelPlMealriseInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlMealrise dataObj ;
	
	public HotelPlMealriseInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlMealriseInput(HotelPlMealrise obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelPlMealrise getHotelPlMealrise() {
		dataObj = new HotelPlMealrise();
