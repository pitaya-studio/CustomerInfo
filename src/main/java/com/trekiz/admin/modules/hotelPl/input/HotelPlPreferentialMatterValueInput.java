...
public class HotelPlPreferentialMatterValueInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlPreferentialMatterValue dataObj ;
	
	public HotelPlPreferentialMatterValueInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlPreferentialMatterValueInput(HotelPlPreferentialMatterValue obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelPlPreferentialMatterValue getHotelPlPreferentialMatterValue() {
		dataObj = new HotelPlPreferentialMatterValue();
