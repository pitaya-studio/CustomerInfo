...
public class HotelPlTaxPriceInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlTaxPrice dataObj ;
	
	public HotelPlTaxPriceInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlTaxPriceInput(HotelPlTaxPrice obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelPlTaxPrice getHotelPlTaxPrice() {
		dataObj = new HotelPlTaxPrice();
