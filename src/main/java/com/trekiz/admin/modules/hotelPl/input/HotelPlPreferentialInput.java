...
public class HotelPlPreferentialInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlPreferential dataObj ;
	
	public HotelPlPreferentialInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlPreferentialInput(HotelPlPreferential obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelPlPreferential getHotelPlPreferential() {
		dataObj = new HotelPlPreferential();
