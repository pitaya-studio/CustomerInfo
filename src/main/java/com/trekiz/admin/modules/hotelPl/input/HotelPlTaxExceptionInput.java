...
public class HotelPlTaxExceptionInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlTaxException dataObj ;
	
	public HotelPlTaxExceptionInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlTaxExceptionInput(HotelPlTaxException obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelPlTaxException getHotelPlTaxException() {
		dataObj = new HotelPlTaxException();
