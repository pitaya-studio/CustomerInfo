...
public class HotelPlRoomMemoInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlRoomMemo dataObj ;
	
	public HotelPlRoomMemoInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlRoomMemoInput(HotelPlRoomMemo obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelPlRoomMemo getHotelPlRoomMemo() {
		dataObj = new HotelPlRoomMemo();
