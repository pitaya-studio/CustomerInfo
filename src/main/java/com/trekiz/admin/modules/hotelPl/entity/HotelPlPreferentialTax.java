...
@Entity
@Table(name = "hotel_pl_preferential_tax")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelPlPreferentialTax   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelPlPreferentialTax";
	...
	/**房费*/
	public static final int PREFERENTIAL_TAX_TYPE_1 = 1;
	/**餐费*/
	public static final int PREFERENTIAL_TAX_TYPE_2 = 2;
	/**交通费*/
	public static final int PREFERENTIAL_TAX_TYPE_3 = 3;
	/**打包优惠时的税金类型*/
	public static final int PREFERENTIAL_TAX_TYPE_4 = 4;
	
	/**没有优惠*/
	public static final int PREFERENTIAL_TYPE_0 = 0;
	/**合计*/
	public static final int PREFERENTIAL_TYPE_1 = 1;
	/**打折*/
	public static final int PREFERENTIAL_TYPE_2 = 2;
	/**减金额*/
	public static final int PREFERENTIAL_TYPE_3 = 3;
	/**减最低*/
	public static final int PREFERENTIAL_TYPE_4 = 4;
	...
	@Transient	
	public String getPreferentialTypeText() {
		if(StringUtils.isEmpty(preferentialTypeText) && preferentialType != null) {
			switch(preferentialType) {
			case PREFERENTIAL_TYPE_1 : preferentialTypeText="合计"; break;
			case PREFERENTIAL_TYPE_2 : preferentialTypeText="打折"; break;
			case PREFERENTIAL_TYPE_3 : preferentialTypeText="减金额"; break;
			case PREFERENTIAL_TYPE_4 : preferentialTypeText="减最低"; break;
			}
		}
		return preferentialTypeText;
	}

	public void setPreferentialTypeText(String preferentialTypeText) {
		this.preferentialTypeText = preferentialTypeText;
	}
	@Transient	
	...
	@Transient	
	public String getIslandWayText() {
		return islandWayText;
	}

	public void setIslandWayText(String islandWayText) {
		this.islandWayText = islandWayText;
	}
	@Transient	
	...
	@Transient	
	public String getIstaxText() {
		return istaxText;
	}

	public void setIstaxText(String istaxText) {
		this.istaxText = istaxText;
	}
