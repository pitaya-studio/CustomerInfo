...
@Entity
@Table(name = "hotel_pl_preferential_matter")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelPlPreferentialMatter   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelPlPreferentialMatter";
	...
	public HotelPlPreferentialMatter(){
	}
