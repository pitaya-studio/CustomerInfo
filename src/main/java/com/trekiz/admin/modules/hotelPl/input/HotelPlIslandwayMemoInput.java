...
public class HotelPlIslandwayMemoInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlIslandwayMemo dataObj ;
	
	public HotelPlIslandwayMemoInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlIslandwayMemoInput(HotelPlIslandwayMemo obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelPlIslandwayMemo getHotelPlIslandwayMemo() {
		dataObj = new HotelPlIslandwayMemo();
