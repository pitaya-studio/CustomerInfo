...
public class HotelPlPreferentialMatterInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelPlPreferentialMatter dataObj ;
	
	public HotelPlPreferentialMatterInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelPlPreferentialMatterInput(HotelPlPreferentialMatter obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelPlPreferentialMatter getHotelPlPreferentialMatter() {
		dataObj = new HotelPlPreferentialMatter();
