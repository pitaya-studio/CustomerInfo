...
public final class DirectorAcceptedState extends SpecificState{
	
	public DirectorAcceptedState(Integer status) {
	    super(status);
	    this.status = status;
    }
    ...
    @Override
    public void run(@SuppressWarnings("rawtypes") StateOwner stateOwner) {
