...
public class CruiseshipAnnexInput  extends BaseInput {
	/**
	...
	public CruiseshipAnnexInput(){
	}
	//数据库映射bean转换成表单提交bean
	public CruiseshipAnnexInput(CruiseshipAnnex obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public CruiseshipAnnex getCruiseshipAnnex() {
		dataObj = new CruiseshipAnnex();
