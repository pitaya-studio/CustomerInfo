...
public class CruiseshipStockLogInput  extends BaseInput {
	/**
	...
	public CruiseshipStockLogInput(){
	}
	//数据库映射bean转换成表单提交bean
	public CruiseshipStockLogInput(CruiseshipStockLog obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public CruiseshipStockLog getCruiseshipStockLog() {
		dataObj = new CruiseshipStockLog();
