...
@Entity
@Table(name = "cruiseship_info")
@DynamicInsert(true)
@DynamicUpdate(true)
public class CruiseshipInfo   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "CruiseshipInfo";
	public static final String ALIAS_ID = "主键";
	public static final String ALIAS_UUID = "uuid";
	public static final String ALIAS_WHOLESALER_ID = "批发商id";
	public static final String ALIAS_NAME = "游轮名称";
