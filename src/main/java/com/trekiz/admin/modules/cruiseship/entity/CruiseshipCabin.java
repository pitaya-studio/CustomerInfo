...
@Entity
@Table(name = "cruiseship_cabin")
@DynamicInsert(true)
@DynamicUpdate(true)
public class CruiseshipCabin   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "CruiseshipCabin";
	...
	public static final String ALIAS_NAME = "舱型名称";
