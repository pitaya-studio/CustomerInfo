...
public class AirticketreservefileTempInput  extends BaseInput {
	//自定义拆分规则定义
	...
	public AirticketreservefileTempInput(){
	}
	//数据库映射bean转换成表单提交bean
	public AirticketreservefileTempInput(AirticketreservefileTemp obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public AirticketreservefileTemp getAirticketreservefileTemp() {
		dataObj = new AirticketreservefileTemp();
