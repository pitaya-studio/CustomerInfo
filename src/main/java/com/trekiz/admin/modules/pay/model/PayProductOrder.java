...
public class PayProductOrder {
		...
		/**
		 * 将支付共用表转换为各个产品线订单支付表
		*<p>Title: copyFromPayProductOrder</p>
		* @return Object 返回类型
		* @author majiancheng
		* @date 2015-6-16 下午6:22:23
		* @throws
		 */
		public Object convertFromPayProductOrder(Object payEntity) {
			BeanUtil.copySimpleProperties(payEntity, this, true);
			return payEntity;
		}
		...
		* @throws
		 */
		public static PayProductOrder convert2PayProductOrder(Object payEntity) {
			PayProductOrder payProductOrder = new PayProductOrder();
			BeanUtil.copySimpleProperties(payProductOrder, payEntity, true);
