...
@Entity
@Table(name = "pay_draft")
@DynamicInsert(true)
@DynamicUpdate(true)
public class PayDraft   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "PayDraft";
	public static final String ALIAS_ID = "主键";
	public static final String ALIAS_UUID = "UUID";
	public static final String ALIAS_DRAWER_NAME = "出票人名称";
	public static final String ALIAS_DRAWER_ACCOUNT = "出票人帐号";
	public static final String ALIAS_PAY_BANK_NAME = "付款行全称";
