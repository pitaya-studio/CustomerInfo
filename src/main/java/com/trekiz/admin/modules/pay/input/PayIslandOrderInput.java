...
public class PayIslandOrderInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private PayIslandOrder dataObj ;
	
	public PayIslandOrderInput(){
	}
	//数据库映射bean转换成表单提交bean
	public PayIslandOrderInput(PayIslandOrder obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public PayIslandOrder getPayIslandOrder() {
		dataObj = new PayIslandOrder();
