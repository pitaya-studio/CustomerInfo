...
public class ActivityHotelGroupPriceInput  extends BaseInput {
	...
	//"删除标志（0:正常，1:删除）"
	private java.lang.String delFlage;
	//columns END
	private ActivityHotelGroupPrice dataObj ;
	
	public ActivityHotelGroupPriceInput(){
	}
	//数据库映射bean转换成表单提交bean
	public ActivityHotelGroupPriceInput(ActivityHotelGroupPrice obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public ActivityHotelGroupPrice getActivityHotelGroupPrice() {
		dataObj = new ActivityHotelGroupPrice();
	...
	public void setDelFlage(java.lang.String value) {
		this.delFlage = value;
	}
	public java.lang.String getDelFlage() {
