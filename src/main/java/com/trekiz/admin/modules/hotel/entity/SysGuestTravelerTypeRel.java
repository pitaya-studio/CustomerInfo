...
@Entity
@Table(name = "sys_guest_traveler_type_rel")
@DynamicInsert(true)
@DynamicUpdate(true)
public class SysGuestTravelerTypeRel   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "SysGuestTravelerTypeRel";
	public static final String ALIAS_ID = "主键";
	public static final String ALIAS_UUID = "uuid";
	public static final String ALIAS_SYS_GUEST_TYPE_UUID = "系统住客类型UUID";
	public static final String ALIAS_SYS_TRAVELER_TYPE_UUID = "系统游客类型UUID";
	...
	public SysGuestTravelerTypeRel(){
	}
	...
	@Column(name="sys_guest_type_uuid")
	...
	@Column(name="sys_traveler_type_uuid")
