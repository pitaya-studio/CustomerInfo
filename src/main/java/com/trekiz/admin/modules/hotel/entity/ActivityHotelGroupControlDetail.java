...
@Entity
@Table(name = "activity_hotel_group_controlDetail")
@DynamicInsert(true)
@DynamicUpdate(true)
public class ActivityHotelGroupControlDetail   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "ActivityHotelGroupControlDetail";
	...
	public static final String ALIAS_HOTEL_CONTROL_DETAIL_UUID = "酒店控房明细uuid";
	public static final String ALIAS_NUM = "使用库存数";
	...
	public ActivityHotelGroupControlDetail(){
	}
