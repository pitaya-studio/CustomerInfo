...
public class HotelRoomMealInput  extends BaseInput {
	...
	public HotelRoomMealInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelRoomMealInput(HotelRoomMeal obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelRoomMeal getHotelRoomMeal() {
		dataObj = new HotelRoomMeal();
