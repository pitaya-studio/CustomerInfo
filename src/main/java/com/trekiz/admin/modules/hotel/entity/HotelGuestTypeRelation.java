...
@Entity
@Table(name = "hotel_guest_type_relation")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelGuestTypeRelation   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelGuestTypeRelation";
	public static final String ALIAS_ID = "主键";
	public static final String ALIAS_UUID = "uuid";
	public static final String ALIAS_HOTEL_GUEST_TYPE_UUID = "酒店住客类型uuid";
	public static final String ALIAS_HOTEL_GUEST_TYPE_NAME = "住客类型名称";
	...
	@Column(name="hotel_guest_type_name")
