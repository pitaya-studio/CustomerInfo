...
@Entity
@Table(name = "activity_hotel_group_meal_rise")
@DynamicInsert(true)
@DynamicUpdate(true)
public class ActivityHotelGroupMealRise   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "ActivityHotelGroupMealRise";
	...
	public static final String ALIAS_HOTEL_MEAL_RISE_UUID = "升级的餐型UUID";
	...
	//酒店产品团期基础餐型表uuid
	private java.lang.String activityHotelGroupMealUuid;
	//升级的餐型UUID
	...
	public ActivityHotelGroupMealRise(){
	}
...
/*	public void setHotelMealRiseUuid(java.lang.String value) {
	...
	*/
	...
	@Column(name="activity_hotel_group_meal_uuid")
	public java.lang.String getActivityHotelGroupMealUuid() {
		return activityHotelGroupMealUuid;
	}

	public void setActivityHotelGroupMealUuid(
			java.lang.String activityHotelGroupMealUuid) {
		this.activityHotelGroupMealUuid = activityHotelGroupMealUuid;
	}
