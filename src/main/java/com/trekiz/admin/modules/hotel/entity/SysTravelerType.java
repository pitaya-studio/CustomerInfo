...
@Entity
@Table(name = "sys_traveler_type")
@DynamicInsert(true)
@DynamicUpdate(true)
public class SysTravelerType   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "SysTravelerType";
	public static final String ALIAS_ID = "主键";
	public static final String ALIAS_UUID = "uuid";
	public static final String ALIAS_SORT = "排序";
	public static final String ALIAS_NAME = "游客类型名称";
	public static final String ALIAS_SHORT_NAME = "游客类型名称";
