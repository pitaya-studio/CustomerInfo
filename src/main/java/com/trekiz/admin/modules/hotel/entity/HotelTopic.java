...
@Entity
@Table(name = "hotel_topic")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelTopic   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelTopic";
	public static final String ALIAS_ID = "主键";
	public static final String ALIAS_UUID = "uuid";
	public static final String ALIAS_SORT = "排序";
	public static final String ALIAS_HOTEL_UUID = "酒店uuid";
	public static final String ALIAS_VIEW_UUID = "字典视图UUID";
	...
	public void setViewUuid(java.lang.String value) {
		this.viewUuid = value;
	}
