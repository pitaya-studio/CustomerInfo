...
public class HotelOrderPriceInput  extends BaseInput {
	...
	public HotelOrderPriceInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelOrderPriceInput(HotelOrderPrice obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelOrderPrice getHotelOrderPrice() {
		dataObj = new HotelOrderPrice();
