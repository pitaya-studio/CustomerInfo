...
@Entity
@Table(name = "hotel_traveler_type_relation")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelTravelerTypeRelation   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelTravelerTypeRelation";
	public static final String ALIAS_ID = "主键";
	public static final String ALIAS_UUID = "uuid";
	public static final String ALIAS_TRAVELER_TYPE_UUID = "游客类型uuid";
	public static final String ALIAS_TRAVELER_TYPE_NAME = "游客类型名称";
	...
	public HotelTravelerTypeRelation(){
	}
	...
	@Column(name="traveler_type_name")
