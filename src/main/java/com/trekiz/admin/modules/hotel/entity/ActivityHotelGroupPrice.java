...
@Entity
@Table(name = "activity_hotel_group_price")
@DynamicInsert(true)
@DynamicUpdate(true)
public class ActivityHotelGroupPrice   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "ActivityHotelGroupPrice";
	...
	public static final String ALIAS_TYPE = "游客类型（数据字典）";
	...
	public static final String ALIAS_DEL_FLAGE = "删除标志（0:正常，1:删除）";
	...
	public ActivityHotelGroupPrice(){
	}
