...
public class ActivityHotelGroupMealInput  extends BaseInput {
	...
	public ActivityHotelGroupMealInput(){
	}
	//数据库映射bean转换成表单提交bean
	public ActivityHotelGroupMealInput(ActivityHotelGroupMeal obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public ActivityHotelGroupMeal getActivityHotelGroupMeal() {
		dataObj = new ActivityHotelGroupMeal();
