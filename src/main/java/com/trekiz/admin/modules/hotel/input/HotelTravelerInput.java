...
public class HotelTravelerInput  extends BaseInput {
	...
	public HotelTravelerInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelTravelerInput(HotelTraveler obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelTraveler getHotelTraveler() {
		dataObj = new HotelTraveler();
