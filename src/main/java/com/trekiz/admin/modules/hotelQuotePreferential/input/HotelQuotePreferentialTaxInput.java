...
public class HotelQuotePreferentialTaxInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelQuotePreferentialTax dataObj ;
	
	public HotelQuotePreferentialTaxInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelQuotePreferentialTaxInput(HotelQuotePreferentialTax obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelQuotePreferentialTax getHotelQuotePreferentialTax() {
		dataObj = new HotelQuotePreferentialTax();
