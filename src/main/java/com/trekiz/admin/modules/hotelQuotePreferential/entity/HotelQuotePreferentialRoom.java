...
@Entity
@Table(name = "hotel_quote_preferential_room")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelQuotePreferentialRoom   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelQuotePreferentialRoom";
	...
	public static final String ALIAS_HOTEL_MEAL_UUIDS = "酒店餐型uuids（数据源是酒店房型餐型关联表读取多个用；分隔）";
	...
	public HotelQuotePreferentialRoom(){
	}
