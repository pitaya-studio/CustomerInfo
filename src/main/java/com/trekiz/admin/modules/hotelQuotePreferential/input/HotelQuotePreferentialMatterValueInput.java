...
public class HotelQuotePreferentialMatterValueInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelQuotePreferentialMatterValue dataObj ;
	
	public HotelQuotePreferentialMatterValueInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelQuotePreferentialMatterValueInput(HotelQuotePreferentialMatterValue obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelQuotePreferentialMatterValue getHotelQuotePreferentialMatterValue() {
		dataObj = new HotelQuotePreferentialMatterValue();
