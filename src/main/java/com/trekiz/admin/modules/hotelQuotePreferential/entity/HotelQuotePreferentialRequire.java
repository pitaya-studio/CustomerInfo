...
@Entity
@Table(name = "hotel_quote_preferential_require")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelQuotePreferentialRequire   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelQuotePreferentialRequire";
	...
	public HotelQuotePreferentialRequire(){
	}
	...
	public String getApplicableThirdPersonText() {
		return applicableThirdPersonText;
	}
