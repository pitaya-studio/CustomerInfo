...
public class HotelQuotePreferentialMatterInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelQuotePreferentialMatter dataObj ;
	
	public HotelQuotePreferentialMatterInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelQuotePreferentialMatterInput(HotelQuotePreferentialMatter obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelQuotePreferentialMatter getHotelQuotePreferentialMatter() {
		dataObj = new HotelQuotePreferentialMatter();
