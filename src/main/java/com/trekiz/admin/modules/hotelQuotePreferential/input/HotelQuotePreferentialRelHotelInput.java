...
public class HotelQuotePreferentialRelHotelInput  extends BaseInput {
	//自定义拆分规则定义
	...
	//columns END
	private HotelQuotePreferentialRelHotel dataObj ;
	
	public HotelQuotePreferentialRelHotelInput(){
	}
	//数据库映射bean转换成表单提交bean
	public HotelQuotePreferentialRelHotelInput(HotelQuotePreferentialRelHotel obj ){
		BeanUtil.copySimpleProperties(this, obj);
	}
	//表单提交的bean转换成数据库映射的bean
	public HotelQuotePreferentialRelHotel getHotelQuotePreferentialRelHotel() {
		dataObj = new HotelQuotePreferentialRelHotel();
