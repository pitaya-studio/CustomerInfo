...
@Entity
@Table(name = "hotel_quote_preferential_rel")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelQuotePreferentialRel   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelQuotePreferentialRel";
	...
	public static final String ALIAS_REL_HOTEL_QUOTE_PREFERENTIAL_UUID = "关联的酒店价单优惠信息uuid";
	...
	public HotelQuotePreferentialRel(){
	}
	...
	@Column(name="rel_hotel_quote_preferential_uuid")
