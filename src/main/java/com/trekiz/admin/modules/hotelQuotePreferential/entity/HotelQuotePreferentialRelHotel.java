...
@Entity
@Table(name = "hotel_quote_preferential_relHotel")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelQuotePreferentialRelHotel   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelQuotePreferentialRelHotel";
	...
	public HotelQuotePreferentialRelHotel(){
	}
