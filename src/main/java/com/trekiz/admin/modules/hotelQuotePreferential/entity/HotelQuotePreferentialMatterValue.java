...
@Entity
@Table(name = "hotel_quote_preferential_matter_value")
@DynamicInsert(true)
@DynamicUpdate(true)
public class HotelQuotePreferentialMatterValue   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "HotelQuotePreferentialMatterValue";
	...
	public static final String ALIAS_HOTEL_QUOTE_PREFERENTIAL_MATTER_UUID = "酒店价单优惠信息优惠事项表uuid";
	public static final String ALIAS_MY_KEYVAR = "定义的模板生成的输入框key值";
	...
	//"酒店价单优惠信息优惠事项表uuid"
	private java.lang.String hotelQuotePreferentialMatterUuid;
	//"定义的模板生成的输入框key值"
	private java.lang.String myKeyvar;
	//"定义的模板生成的输入框value值"
	...
	public HotelQuotePreferentialMatterValue(){
	}
	...
	public void setHotelQuotePreferentialMatterUuid(java.lang.String value) {
		this.hotelQuotePreferentialMatterUuid = value;
	}
	@Column(name="hotel_quote_preferential_matter_uuid")
	public java.lang.String getHotelQuotePreferentialMatterUuid() {
		return this.hotelQuotePreferentialMatterUuid;
	}
	
		
	public void setMyKeyvar(java.lang.String value) {
		this.myKeyvar = value;
	}
	@Column(name="myKeyvar")
	public java.lang.String getMyKeyvar() {
		return this.myKeyvar;
	}
