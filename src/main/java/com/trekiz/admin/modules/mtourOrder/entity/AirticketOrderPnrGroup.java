...
@Entity
@Table(name = "airticket_order_pnrGroup")
@DynamicInsert(true)
@DynamicUpdate(true)
public class AirticketOrderPnrGroup   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "AirticketOrderPnrGroup";
	public static final String ALIAS_ID = "主键";
	public static final String ALIAS_UUID = "UUID";
	public static final String ALIAS_AIRTICKET_ORDER_ID = "机票订单id";
	public static final String ALIAS_TICKET_PERSON_NUM = "出票人数（默认是0）";
	public static final String ALIAS_PERSON_NUM = "每组预订人数（总和等于订单的总人数）";
	...
	@Column(name="pnr_group_index")
	public int getPnrGroupIndex() {
		return pnrGroupIndex;
	}

	public void setPnrGroupIndex(int pnrGroupIndex) {
		this.pnrGroupIndex = pnrGroupIndex;
	}
