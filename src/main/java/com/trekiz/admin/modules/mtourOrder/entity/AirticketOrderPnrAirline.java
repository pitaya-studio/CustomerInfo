...
@Entity
@Table(name = "airticket_order_pnr_airline")
@DynamicInsert(true)
@DynamicUpdate(true)
public class AirticketOrderPnrAirline   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "AirticketOrderPnrAirline";
	...
	public static final String ALIAS_AIRLINE_NAME = "航段名称";
	...
	public AirticketOrderPnrAirline(){
	}
