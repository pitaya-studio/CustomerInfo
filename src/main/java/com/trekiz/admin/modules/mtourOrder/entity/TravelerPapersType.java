...
@Entity
@Table(name = "traveler_papers_type")
@DynamicInsert(true)
@DynamicUpdate(true)
public class TravelerPapersType   extends BaseEntity {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "TravelerPapersType";
	public static final String ALIAS_ID = "主键";
	public static final String ALIAS_UUID = "UUID";
	public static final String ALIAS_TRAVELER_ID = "游客信息表ID";
