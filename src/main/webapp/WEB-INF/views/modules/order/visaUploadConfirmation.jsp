...
<div class="ydbzbox fs">
		...
		<div id="offline_paybox" class="pay_clearfix" style="clear: both;"><!--去掉width=750-->
			...
			<div class="payORDER"
				...
				<div id="offlinebox_5" class="payDiv">
					<form id="offlineform_5" method="post" enctype="multipart/form-data" action="${ctx}/visa/order/visaUploadConfirmation" style="margin:0px; padding:0px;">
	...
	<div class="ydbz_sxb ydbz_button">
		<a class="ydbz_s" href="${ctx}/visa/order/goUpdateVisaOrder?visaOrderId=${orderId}&details=1">查看订单</a>
