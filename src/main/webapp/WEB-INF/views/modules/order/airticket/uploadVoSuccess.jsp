                ...
                <div class="payforok">
                    <div class="payforok-inner">
                        <h3 class="payforok-title">&nbsp;&nbsp;恭喜！凭证上传成功</h3>
							...
							<p class="payforokbtn">
								<a class="ydbz_s" href="${ctx}/order/manage/airticketOrderDetail?orderId=${pra.id}" style="margin-left: 125px;">查看订单详情</a>
								<a href="${ctx}" class="payforokbtn3" style="margin-left: -135px;">回到首页</a>
							</p>
                    </div>
                </div>
