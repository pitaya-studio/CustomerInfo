	...
	$().ready(function() {
	 ...
	 $("#offlineform_5").validate({
		...
		function inFileName(obj){
			var flag = $(obj).fileInclude({includes:[".jpg",".jpeg",".gif",".png",".pdf",".tif",".PNG","JPG"]});
    		if(!flag){
    			// IE
    			if($.browser.msie){
    				obj.outerHTML+='';
	...
	<div id="offline_paybox" class="pay_clearfix" style="clear: both;"><!--去掉width=750-->
		...
		<div class="payORDER"
			...
			<div id="offlinebox_5" class="payDiv">
				<form id="offlineform_5" method="post" enctype="multipart/form-data" action="${ctx}/orderCommon/manage/modifypayVoucherFile" style="margin:0px; padding:0px;">
