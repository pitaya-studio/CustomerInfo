...
function applyGroupRefund() {
	...
	window.location.href ="${ctx}/orderCommon/manage/applyIslandGroupRefund?orderUuid=${orderUuid}&id=${orderId}&productType=${productType}";
}
function viewOrderInfo(productType,rid,orderId){
window.open("${ctx}/orderCommon/manage/viewIslandApplyRefundInfo?orderUuid=${orderUuid}&orderId="+orderId+"&rid="+rid+"&productType="+productType);
}
</script>
</head>
<body>
				<!--右侧内容部分开始-->
                <div class="mod_nav">订单&nbsp;&nbsp;>海岛游&nbsp;&nbsp;>退款记录</div>
