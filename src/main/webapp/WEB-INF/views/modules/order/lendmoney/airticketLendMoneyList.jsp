...
<script type="text/javascript" src="${ctxStatic}/modules/order/airticketlendmoeny/airticketLoanApplication.js"></script>
...
<body>
	<!--右侧内容部分开始-->
				...
				<%@ include file="/WEB-INF/views/modules/order/lendmoney/airticketLoanApplication.jsp"%>
	<!--右侧内容部分结束-->
</body>
</html>