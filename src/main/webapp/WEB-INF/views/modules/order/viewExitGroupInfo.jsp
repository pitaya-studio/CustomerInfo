...
&nbsp;&nbsp;>退团审核&nbsp;&nbsp;>审核详情</div>
				...
				<div class="ydbz_tit">
					<span class="fl">游客退团</span><span class="fr wpr20">报批日期：<fmt:formatDate value="${hashMap.reviewInfo.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/> </span>
        		</div>
				<table id="contentTable" class="table activitylist_bodyer_table">
                    ...
                    <tbody>                    
						<tr>
							<td>${hashMap.travelerInfo.name}</td>
							<td>
							<fmt:formatDate value="${hashMap.travelerInfo.orderTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
							</td>
							<td class="tr"><span class="tdred">${hashMap.travelerInfo.payPrice}</span></td>							
