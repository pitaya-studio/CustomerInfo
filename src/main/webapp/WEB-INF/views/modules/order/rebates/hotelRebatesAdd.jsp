                    ...
                    <table id="commissionTable" class="activitylist_bodyer_table modifyPrice-table activitylist_bodyer_table_new activitylist_bodyer_table_new">
                        ...
                        <c:forEach items="${travelerRebatesList}" var="travelerRebates" varStatus="s">
		  					...
		  					<td class="table_borderLeftN"><input type="checkbox" data-group="commission" name="checkSign" /></td>
								...
								<td class="tr">${fns:getHotelMoneyAmountBySerialNum(travelerRebates.traveler.payPriceSerialNum,2)}</td>
								<td class="tr">${fns:getTravelRebatesByOrderType(travelerRebates.traveler.uuid,11)}<input type="hidden" name="oldRebates" value="${travelerRebates.oldRebates}"></td>
								...
								<td width="10%"><input type="text"
									maxlength="9" name="refund" class="money" data-type="float"
									onkeyup="refundInput(this)" onafterpaste="refundInput(this))" />
								</td>
                            ...
                            <tr>
                                <td class="tc">总计</td>
                                <td colspan="9" class="tc"><span class="f14 all-money mar_ri20">应收总金额：<span class="red20">${totalTravelerPrice}</span></span> <span class="f14 all-money mar_l20">累计返佣总金额：<span class="red20">${totalRebatesMoney }</span></span> <span class="f14 all-money mar_l20">本次返佣总金额：<span id="totalAmount"><span class="red20">0.00</span></span></span></td>
                            </tr>
                        </tbody>
                    </table>
            ...
            function totalAmount() {
                ...
                for (var key in amount) {
                    if (amount[key]) {
                        ...
                        var money = Math.abs(amount[key]).toFixed(2);
