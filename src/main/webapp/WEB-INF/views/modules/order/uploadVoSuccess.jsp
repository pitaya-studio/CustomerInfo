                ...
                <div class="payforok">
                    <div class="payforok-inner">
                        <h3 class="payforok-title">&nbsp;&nbsp;恭喜！凭证上传成功</h3>
							...
							<p class="payforokbtn">
								<a href="${ctx}/orderList/manage/showOrderList/0/${pra.orderStatus}.htm?orderNumOrGroupCode=${pra.orderNum}">我的订单</a>
								<a href="javascript:void(0)" onClick="orderDetail('${pra.id}')">查看订单详情</a>
