...
$(function(){
	...
	var oldGroupCode = $("#oldGroupCode").text();
	if(oldGroupCode.length > 20) {
		oldGroupCode = oldGroupCode.substring(0, 20) + "...";
	}
	$("#oldGroupCode").text(oldGroupCode);
...
<body>
		<page:applyDecorator name="transfer_group_apply" >
    		</page:applyDecorator>
         <!--右侧内容部分开始-->
         ...
         <div class="ydbzbox fs">
            <div class="orderdetails">
               		...
               		<table border="0" style="margin-left: 25px" width="98%">
						<tbody>
							...
							<tr> 
								...
								<td class="mod_details2_d2" title="${group.groupCode }" id="oldGroupCode">${group.groupCode }</td>
               ...
               <div class="orderdetails2">
                  <p class="ydbz_mc">${product.acitivityName }</p>
                     ...
                     <li id="mddtargetAreaNames" title="" class="orderdetails2_text" title="${product.targetAreaNames}"><span >目的地：</span>
				   	...
				   	<c:if test="${not empty travelList }">
				   		<c:forEach  items="${travelList }"  var="travel"  varStatus = "code">
							 ...
							 <td>
								...
								<!-- 这里maxlength > 9 时，会报错。 -->
								<input type="text" name="subtractMoney" maxlength="9" onkeyup="refundInput(this)" onafterpast="refundInput(this)" value="0" style="width: 100px">
							 </td>
			...
			<div class="ydBtn ydBtn2">
              <!-- <a class="ydbz_s" onClick="window.close();">关闭</a><a class="ydbz_s" onclick="applySwitchTeam();" id="formSubmit"  style="display:none">申请转团</a>-->
