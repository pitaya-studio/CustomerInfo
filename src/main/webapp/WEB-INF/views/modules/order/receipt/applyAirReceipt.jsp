...
<input id="orderType" value="${orderType}" type="hidden">
	<!-- 顶部参数 -->
<div class="activitylist_bodyer_right_team_co_bgcolor" style="float:left;width: 100%">
    <div class="mod_nav">订单 > 机票 > 申请开收据</div>
 <!--右侧内容部分开始-->
              ...
              <table class = "ta_orderinfo" border="0"  width="100%" style="margin-bottom:10px">
                <tbody>
                  <tr>
                    ...
                    <td class="mod_details2_d1_five">乘机日期：</td>
                    <td class="mod_details2_d2_five">${invoiceOrderInfo.startTime}</td>
