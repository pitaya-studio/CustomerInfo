...
function applyGroupRefund() {
	...
	window.location.href ="${ctx}/orderCommon/manage/applyGroupRefund?id=${orderId}&productType=${productType}";
}
function viewOrderInfo(productType,rid,orderId){
window.open("${ctx}/orderCommon/manage/viewApplyRefundInfo?orderId="+orderId+"&rid="+rid+"&productType="+productType);
}
...
<div class="activitylist_bodyer_right_team_co_bgcolor" style="float:left;width: 100%">
 ...
 <!--右侧内容部分开始-->
				...
				<c:if test="${sign == 0 }">
				<!--
				<a href="javascript:applyGroupRefund()">申请退款</a>
				-->
				</c:if>
				
				
				</p>
				<div class="ydbz_tit">退款记录</div>
				<table id="contentTable" class="activitylist_bodyer_table">
				   ...
				   <c:forEach items="${page }" var="map">
                      ...
                      <tr>
                         ...
                         <td class="tr">${o.currencyMark}${o.refundPrice}</td>
						 <td>${o.remark}</td>
						 <td>
