...
label {
	...
	<p class="main-right-topbutt">
		<a href="${ctx }/agent/manager/firstForm">新增渠道商</a>
	</p>
	<form:form id="searchForm" method="post" action="${ctx }/agent/manager/queryList" modelAttribute="agentinfo">
		...
		<div class="activitylist_bodyer_right_team_co">
			<div class="activitylist_bodyer_right_team_co2 wpr20 pr">
				...
				<input value="${agentName}" class="inputTxt inputTxtlong" name="agentName" id="" flag="istips"> 
				...
				<table class="table activitylist_bodyer_table" id="contentTable">
					<thead>
						<tr>
							...
							<th width="18%">营业额（应收）</th>
							<th width="18%">营业额（实收）</th>
							<th width="18%">营业额（达账）</th>
							<th width="6%">游客数(人)</th>
							<!-- 如果是非签约渠道，则没有操作项 -->
							<c:if test="${signChannel == '0'}">
								<th width="6%">跟进销售员</th>
