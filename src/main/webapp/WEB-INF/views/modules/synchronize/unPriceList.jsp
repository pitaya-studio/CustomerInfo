...
<html>
<head>
	<title>成人价格不存在异常</title>
	<meta name="decorator" content="wholesaler"/>
	<script type="text/javascript">
		$(function(){
			$('#unPrice').attr('class', 'active');
		});
		function page(n,s) {
			$("#pageNo").val(n);
			$("#pageSize").val(s);
...
<body>
	<!-- <ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="synchronize:view"><li class="active"><a href="${ctx}/synchronizeUnPriceLog/manage/unPrice">成人价格不存在异常</a></li></shiro:hasPermission>
	...
	<form:form id="searchForm" modelAttribute="unPriceSynchronizeLog" action="${ctx}/synchronizeUnPriceLog/manage/unPrice" method="post" class="breadcrumb form-search">
