...
<body>
	<!-- <ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="synchronize:view"><li class="active"><a href="${ctx}/synchronizeExceptionLog/manage/solved">已解决异常团期同步</a></li></shiro:hasPermission>
	...
	<form:form id="searchForm" modelAttribute="exceptionSynchronizeLog" action="${ctx}/synchronizeExceptionLog/manage/solved" method="post" class="breadcrumb form-search">
