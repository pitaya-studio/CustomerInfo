...
<body>
	<!-- <ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="synchronize:view"><li class="active"><a href="${ctx}/synchronizeSuccessLog/manage/success">成功团期同步</a></li></shiro:hasPermission>
	...
	<form:form id="searchForm" modelAttribute="successSynchronizeLog" action="${ctx}/synchronizeSuccessLog/manage/success" method="post" class="breadcrumb form-search">
