...
<style type="text/css">
	...
	<body>
				...
				<tbody>
					...
					<tr>
						...
						<td class="f3" colspan="7">
							<div class="dayinzy_w698">项目备注：${remark};付款备注：${remark1}</div>
						</td>
					</tr>
					<tr>
						<td class="f2">收款单位</td>
						<td class="fl f3" colspan="7" >&nbsp;${orderCompanyName}&nbsp;&nbsp;${accountName} </td>
					</tr>
					<tr>
		...
		<div class="dbaniu">
			...
			<input id="" name="" type="button" class="ydbz_s" value="下载" onclick="downloadJKD('${ctx}/review/visaRebates/downloadRebatesPrintSheet?revid=${revid}&payId=${payId}&option=${option}');">
		</div>
		<script type="text/javascript">
