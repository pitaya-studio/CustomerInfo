	...
	<body>
		...
		<div class="dbaniu">
			<shiro:hasPermission name="rebatesReview:print:down">
				...
				<input id="" name="" type="button" class="ydbz_s" value="下载" onclick="downloadJKD('${ctx}/airticketRebates/airticketRebatesDownload?reviewId=${map.reviewId}&payId=${map.payId}&groupCode=${map.groupCode}&option=${map.option}',${map.reviewId});">
			</shiro:hasPermission>
		</div>
		<script type="text/javascript">
			...
			function updateTime(reviewId){
				$.ajax({
			        type: "POST",
			        url: "${ctx}/order/rebates/review/updatePrintTime?reviewId=" + reviewId,
			        dataType:"json",
			        async:false,
			        cache:false,
			        data:{
