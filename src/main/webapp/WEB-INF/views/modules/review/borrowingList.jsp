...
window.open("${ctx}/orderReview/manage/viewBorrowingReviewInfo?orderId=" + orderId + "&rid="+rid+"&roleId="+roleId+"&userLevel=${reviewVO.userLevel}");
}
//审核退团申请
function reviewBorrowing(roleId,orderId,rid){
window.open("${ctx}/orderReview/manage/reviewBorrowingInfo?orderId=" + orderId + "&rid="+rid+"&roleId="+roleId+"&userLevel=${reviewVO.userLevel}");
}
//同一审核流程切换审核角色查询
