...
<html>
<head>
<title>审核-还签证押金收据activity</title>
<!-- 页面左边和上边的装饰 -->
...
<body>
		...
		<!--右侧内容部分开始-->
		<div class="mod_nav">审核 > 还签证押金收据 > 还签证押金收据审批</div>
		...
		<table id="contentTable" class="activitylist_bodyer_table">
		   ...
		   <tbody>
			  <tr>
				 ...
				 <td class="tr">${revCurrency.currencyMark } ${revDepositReceiptAmount }</td>
				...
				<div class="dbaniu"  style="text-align:center;">
				      <c:choose> 
					     <c:when test="${flag==0}"> 
								...
								<a class="ydbz_s" onclick="review('${revid}');">审核通过</a>
					     </c:when> 
					     <c:otherwise> 
