			...
			$("#inputForm").validate({
				rules:{
					label:{
						...
						remote: {
							type: "POST",
							url: "${ctx}/cruiseshipStock/check?type="+$('#type').val()+"&uuid="+$('#uuid').val()
								}
						},
					sort:{
						required:true,
				...
				submitHandler: function(form){
					var url = "";
					if($("#uuid").val()=='') {
						url="${ctx}/cruiseshipStock/save";
					} else {
						url="${ctx}/cruiseshipStock/update";
					}
...
<body>
	...
	<form:form method="post" modelAttribute="cruiseshipStockInput" action="" class="form-horizontal" id="inputForm" novalidate="">
		...
		<div class="maintain_add">
			...
			<p>
				...
				<input readonly onclick="WdatePicker()" value="<fmt:formatDate value="${cruiseshipStock.shipDate}" pattern="yyyy-MM-dd" />" name="shipDate" class="inputTxt dateinput" id="shipDate" />
			</p>
			<p>
			...
			<p>
				...
				<input readonly onclick="WdatePicker()" value="<fmt:formatDate value="${cruiseshipStock.createDate}" pattern="yyyy-MM-dd" />" name="createDate" class="inputTxt dateinput" id="createDate" />
			</p>
			<p>
			...
			<p>
				...
				<input readonly onclick="WdatePicker()" value="<fmt:formatDate value="${cruiseshipStock.updateDate}" pattern="yyyy-MM-dd" />" name="updateDate" class="inputTxt dateinput" id="updateDate" />
			</p>
			<p>
