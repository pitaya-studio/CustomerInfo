...
<html>
<head>
<title>审批优化-审批配置界面-单据-借款单</title>
...
<table class="print-base-form">
	...
	<tbody>
	<tr>
		<td width="112" colspan="2" class="tc f2">借款单位</td>
		<td colspan="2" class=" f3 paddl">&nbsp;</td>
		<td colspan="2" class="tc f3 paddl">经办人<span class="tc f2"></span></td>
		<td colspan="2" class=" f3 paddl">&nbsp;</td>
	</tr>
	<tr>
		<td colspan="2" class="tc f2">借款理由</td>
		<td class=" f3" colspan="6"><div class="duohangnormal"></div></td>
	</tr>
	<tr>
		<td colspan="2" class="tc f2">借款金额</td>
		<td class=" f3" colspan="2">&nbsp;</td>
		<td colspan="2"  class="tc f3">￥</td>
		<td colspan="2" class=" f3">&nbsp;</td>
	</tr>
	<tr>
		<td colspan="2" class="tc f2 vertical-align-top-td" >领款人<span class="tc f2"></span></td>
