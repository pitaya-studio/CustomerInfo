...
<head>
	...
	<title>基础信息维护-岛屿管理-添加岛屿信息</title>
		...
		<div class="produceDiv">
			<form:form method="post" modelAttribute="island" action="" class="form-horizontal" id="inputForm" novalidate="">
				...
				<div class="seach25">
                    ...
                    <form:select path="position" class="domesticOverseas required" onchange="domesticOverseas(this);">
				...
				<div class="sysdiv sysdiv_coupon">
					...
					<p class="domestic">
                        ...
                        <span class="sysselect_s">
                            <form:select path="country"><form:option value="">请选择</form:option></form:select>
	                        <form:select path="province"><form:option value="">请选择</form:option></form:select>
	                        <form:select path="city"><form:option value="">请选择</form:option></form:select>
	                        <form:select path="district"><form:option value="">请选择</form:option></form:select>
                    ...
                    <p class="overseas">
                        ...
                        <span class="sysselect_s">
                            ...
                            <select id="overseas_state" name="overseas_state">
                         	...
                         	<select id="overseas_province" name="overseas_province">
                         	</select>
