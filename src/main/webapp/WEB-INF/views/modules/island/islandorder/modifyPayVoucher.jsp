...
<div class="payforprice">支付凭证金额为：<span><i>${orderpay.moneySerialNum}</i></span>
订单总额为：<span><i>${islandOrder.totalMoney}</i></span>
</div>

<div class="payforchose">重新上传付款凭证</div>
	...
	<div id="offline_paybox" class="pay_clearfix" style="clear: both;"><!--去掉width=750-->
		...
		<div class="payORDER"
			...
			<div id="offlinebox_5" class="payDiv">
				<form id="offlineform_5" method="post" enctype="multipart/form-data" action="${ctx}/islandOrder/modifypayVoucherFile" style="margin:0px; padding:0px;">
					<input type="hidden" name="orderUuid" value="${islandOrder.uuid}">
					<input type="hidden" name="payUuid" value="${orderpay.uuid}">
					<table width="100%" cellpadding="5" cellspacing="0" border="0">
						<tbody>
								<tr class="trVoucher_5">
								<td class="trtextaling" width=""><span style="color:#f00;">*</span>支付凭证：</td>
		...
		<div class="ydbz_sxb ydbz_button">
			<a class="ydbz_s" href="${ctx}/islandOrder/islandOrderDetail/${islandOrder.uuid}">查看订单</a>
