                ...
                <div class="payforok">
                    <div class="payforok-inner">
                        <h3 class="payforok-title">&nbsp;&nbsp;恭喜！凭证上传成功</h3>
							...
							<p class="payforokbtn">
								<a href="${ctx}/islandOrder/list/0.htm?orderNumOrGroupCode=${islandOrder.orderNum}">我的订单</a>
								<a href="${ctx}/islandOrder/islandOrderDetail/${islandOrder.uuid}"  target="_blank">查看订单详情</a>
