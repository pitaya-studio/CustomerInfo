				...
				<table class="activitylist_bodyer_table modifyPrice-table activitylist_bodyer_table_new">
				   ...
				   <c:forEach items="${tralist}" var="borrowing">
					  <tr group="travler1">
                         ...
                         <td class="tr">${fns:getHotelMoneyAmountBySerialNum(traveler.payPriceSerialNum,2)}</td>
						 <td class="tr">${fns:getBorrowPayMoneyTravelByOrderType(orderUuid,traveler.uuid,11)}</td>
