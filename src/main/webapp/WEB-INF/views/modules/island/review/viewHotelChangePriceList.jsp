...
<body>
<div id="sea">
<div class="mod_nav">订单 > 酒店  > 改价记录</div>
				<!--右侧内容部分开始-->
				...
				<c:otherwise>
				<a class="ydbz_x" href="${ctx}/island/review/upHotelPrices?orderId=${orderId}&productType=11&flowType=${flowType}&orderUuid=${orderUuid}">申请改价</a>
				</c:otherwise>
				</c:choose>
				</div>
				<table id="contentTable" class="activitylist_bodyer_table">
					<thead>
						<tr>
                         ...
                         -->
                         <th width="5%">款项</th>
						 <th width="10%">改前应收价</th>
						 <th width="10%">改后应收价</th>
						 <th width="10%">申请人</th>
						 <th width="10%">审批动态</th>
						 <th width="10%">备注</th>
						 <th width="10%">操作</th>
					...
					<tr>
						...
						<td>${fns:getSysTravelerNameById(airticketReturnReview.travelerid,'11')}</td>
<%--						<td>--%>
<%--							<trekiz:autoId2Name4Table tableName="traveler_type" sourceColumnName="uuid" srcColumnName="name" value="${airticketReturnReview.personType}"/>--%>
<%--							${airticketReturnReview.personType }--%>
<%--						</td>--%>
						...
						<td class="p0">
							<dl class="handle">
								...
								<dd class="">
									<p>
										<span></span> 
										<a href="${ctx}/island/review/viewHotelChangePriceInfo?id=${airticketReturnReview.id}&orderId=${airticketReturnReview.orderId}&productType=${airticketReturnReview.productType}&flowType=${airticketReturnReview.flowType}&orderUuid=${orderUuid}">改价详情</a>
									</p>
								</dd>
							</dl> 
						</td>
