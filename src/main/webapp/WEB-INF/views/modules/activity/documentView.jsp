...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctxStatic}/js/flexpaper_flash.js"></script>
		<script type="text/javascript" src="${ctxStatic}/js/flexpaper_flash_debug.js"></script>
		...
		<div style="position: absolute; left: 50px; top: 10px;">
			...
			<script type="text/javascript"> 
				var fp = new FlexPaperViewer(
						 ...
						 SwfFile : encodeURI('<%=basePath%>/${filePath}'),//编码设置
						 Scale : 0.6,
