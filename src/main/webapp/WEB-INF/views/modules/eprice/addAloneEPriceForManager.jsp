...
<head>
	...
	<script src="${ctxStatic}/modules/eprice/addAloneEPriceForManager.js" type="text/javascript"></script>
	...
	$(function(){
		...
		$("#formanagerAlone").comboboxInquiry();
		$("#formanagerTicket").comboboxInquiry();
          ...
          <form id="eprice-a-form-id">
           ...
           <div class="inquiry_radio_people1" name="inquiry_radio_people">
	            ...
	            <div class="seach25">
		              ...
		              <p class="seach_r"><input type="text"  name="contactMobile" maxlength="16" /></p>
	            </div>
	            <div class="seach25">
		              <p>其他联系方式：</p>
        ...
        <div class="messageDiv inquiry_box2"  style="width:1040px">
          <form id="eprice-b-form-id">
          	<div class="seach25 seach100">
	              <p class="seach_r">
	                <span class="xing">*</span>接待社计调主管：
	              	<span class="seach_check">
		                <select name="formanager" id="formanagerAlone" style="width:160px">
		                	<option>请搜索计调主管</option>
            ...
            <!-- 询价接待要求 -->
            <div id="eprice-travel-require-div-id"></div>
        	...
        	<div class="seach25 seach100">
          	...
          	<div class="inquiry_box3_check" id="eprice-c-div-id">
          		<form id="eprice-c-form-0-id">
	            	...
	            	<!-- 机票相关-->
		            <div class="seach30 seach100">
			              <p class="seach_r">
			              	<span class="xing">*</span>机票计调主管：
			              	<span class="seach_check">
				                <select name="formanager" id="formanagerTicket" style="width:160px">
		                			<option>请搜索计调主管</option>
				                	<c:forEach items="${managerList }" var="ml">
				                		<option value="${ml.id }">${ml.name}</option>
				                	</c:forEach>
