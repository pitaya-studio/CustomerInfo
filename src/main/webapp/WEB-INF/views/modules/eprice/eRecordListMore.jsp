...
<head>
	...
	<script src="${ctxStatic}/modules/eprice/eRecordListMore.js" type="text/javascript"></script>
...
<body>
	<!--右侧内容部分开始-->
        ...
        <div class="messageDiv" flag="messageDiv">
            ...
            <!-- 
            <div class="seach25">
              <p>申请总人数：</p>${project.lastBaseInfo.allPersonSum}
            </div>
            <div class="seach25">
              <p>成人人数：</p>${project.lastBaseInfo.adultSum}
            </div>
            <div class="seach25 pr">
              <p>儿童人数：</p>${project.lastBaseInfo.childSum}
            </div>
            <div class="seach25">
              <p>特殊人群数：</p>${project.lastBaseInfo.specialPersonSum}
            </div>
            <div class="kong"></div>
        	 -->
        </div>
          ...
          <div class="activitylist_paixu">
            <div class="activitylist_paixu_left">
              <ul id="sort-list-ul-id">
                ...
                <li class="activitylist_paixu_left_biankuang liupdateDate" sortc="lastAoperatorPriceTime" sortv="1"><a >报价时间<i class="icon" style="display: none;"></i></a></li>
                <!-- 
            ...
            <thead>
              <tr>
                <th width="4%">序号</th>
                        ...
                        <th width="7%">计调员</th>
                        <th width="9%">报价日期</th>
                        <th width="9%">预计出团日期</th>
                        <th width="9%">境外停留天数</th>
                        <th width="8%">线路国家</th>
                        <th width="10%">成本价</th>
                        <th width="10%">外报价</th>
                        <th width="10%">结算价</th>
