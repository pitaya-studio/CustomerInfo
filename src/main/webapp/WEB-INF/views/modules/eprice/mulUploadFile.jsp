...
<script type="text/javascript" src="${ctxStatic}/jquery-uploadfile/jquery.uploadify.min.js"></script>
...
$(document).ready(function() {
 //mark fix uploadify chrome error.
    ...
    $('#file_upload').uploadify({
        ...
        'uploader':'${ctx}/eprice/manager/ajax/project/file/upload;jsessionid=<%=session.getId()%>',
...
<p>
    ...
    <a href="javascript:$('#file_upload').uploadify('cancel',$('.uploadifive-queue-item').first().data('file'))">取消上传</a>
    <a href="javascript:$('#file_upload').uploadify('cancel','*')">清空所有的上传文件</a>
    <a href="javascript:$('#file_upload').uploadify('stop','*')">暂停</a>
    <a href="javascript:void(0)" onClick="$(this).prev().eq(2).click(); setUpoaldPath();" class="successUpload"></a>
</p>
