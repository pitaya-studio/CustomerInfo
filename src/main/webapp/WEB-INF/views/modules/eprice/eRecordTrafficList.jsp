...
<script src="${ctxStatic}/jquery/ajaxfileupload.js"
	type="text/javascript"></script>
<script src="${ctxStatic}/modules/eprice/eRecordTrafficList.js"
	type="text/javascript"></script>
...
<body>
	...
	<page:applyDecorator name="eprice_repay_record" >
    </page:applyDecorator>		 		 
		<div class="activitylist_bodyer_right_team_co_bgcolor">
			<form id="eprice-search-form-id">
						<input type="hidden" name ="replayType" value="7"/>
				...
				<div class="activitylist_bodyer_right_team_co">
					<div class="activitylist_bodyer_right_team_co2 pr">
						 <input class="txtPro inputTxt"
							id="wholeSalerKey" name="keyword" flag="istips" placeholder="销售姓名/客户" />
					</div>
					...
					<ul id="sort-list-ul-id">
						...
						<li class="activitylist_paixu_left_biankuang liupdateDate"
							sortc="lastOperatorGivenTime" sortv="1"><a>报价时间<i
								class="icon" style="display: none;"></i></a></li>
						<li class="activitylist_paixu_left_biankuang lisettlementAdultPrice"  style="width:100px"
				...
				<thead style="background: #403738">
					<tr>
						...
						<shiro:hasPermission name="enquiry:agentinfo:visibility">
							<th width="8%">客户联系人</th>
							<input type="hidden" id="agentinfo_visibility" value="1" >
						</shiro:hasPermission>
						<th width="10%">询价类型</th>
