...
function denyCost(dom,id,reviewLevel){
  ...
  $.ajax({
                     ...
                     dataType:"json",
                     async:false,
                     data:{  format:"json",id :id,reviewLevel:reviewLevel, reviewCompanyId :${reviewCompanyId},orderType:7  },
...
function saveCheckBox(id){   
    ...
    $.ajax({
                        ...
                        async:false,
                        data:{ 
                            costList:tmp, reviewCompanyId :${reviewCompanyId},orderType:7   },
                        success: function(array){ 
                            window.location.reload();       
...
<input type="hidden" name="budgetType" id="budgetType" value="1"/>
		<!--右侧内容部分开始-->
			<div class="mod_nav">财务 > 财务审核 > 成本审核 > 机票录入审核</div>
