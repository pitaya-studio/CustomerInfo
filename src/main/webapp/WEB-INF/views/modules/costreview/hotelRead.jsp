...
<body>
     	...
     	<c:choose>
     		<c:when test="${flag eq '1' }">
     			<page:applyDecorator name="new_cost_review_head">
			    	<page:param name="showType">hotel</page:param>
			    </page:applyDecorator>
     		</c:when>
     		<c:otherwise>
    ...
    <!-- <div class="mod_nav"><c:if test="${empty title}">财务 > 财务审核 > 成本审核 > 酒店成本审核</c:if><c:if test="${!empty title}">${title}</c:if></div> -->
            ...
            <div class="mod_information_dzhan_d mod_details2_d">
                ...
                <table border="0" width="90%">
                    <tr>
                        ...
                        <td class="mod_details2_d2">${activityHotel.activitySerNum }</td>
                        <td class="mod_details2_d1">计调员：</td>
                        <td class="mod_details2_d2">${fns:getUserNameById(activityHotel.createBy) }</td>
                        <td class="mod_details2_d1">下单人：</td>
                        <td class="mod_details2_d2">
                        	<c:forEach items="${hotelOrders}" var="hotelOrder">
                        		${fns:getUserNameById(hotelOrder.createBy) }
                        	</c:forEach>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="mod_details2_d2">${activityGroup.remNumber }间（控房 ${activityGroup.controlNum }间  非控房 ${activityGroup.uncontrolNum }间）</td>
                        <td class="mod_details2_d1">预报名：</td>
                        <td class="mod_details2_d2">${forecaseReportNum }间</td>
                    ...
                    <tr>
                        ...
                        <td class="mod_details2_d2">${activityGroup.airline}</td>
                        <td class="mod_details2_d1">备注：</td>
                        <td class="mod_details2_d2">${activityHotel.memo }</td>
                    </tr>
                </table>
                <div class="kong"></div>
