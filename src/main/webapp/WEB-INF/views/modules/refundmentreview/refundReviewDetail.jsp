...
<body>
	<!--右侧内容部分开始-->
	<div class="mod_nav">审批 > 退款审批 > 退款审批审批</div>
...
<!-- 兼容游轮 注释掉了这里 替换为下面的模块
	...
	<c:if test="${flag == 0}">
		<div class="dbaniu">
			<form id="searchForm" action="${ctx}/refundmentReview/refundReview" method="post">
				<!-- 添加提交请求所需数据 -->
				...
				<input id = "succBtn" type="button" value="审批通过" onclick="review(${reviewdetail.id},${nowlevel},1,'',${reviewdetail.refundPrice},${orderDetail.prdtype},${orderDetail.orderid},${reviewdetail.currencyId})" class="btn btn-primary">
			</form>
		</div>
	</c:if>
