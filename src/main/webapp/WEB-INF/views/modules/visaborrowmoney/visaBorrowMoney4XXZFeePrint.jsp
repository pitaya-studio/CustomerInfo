...
<style type="text/css">
	...
	<body>
		...
		<div class="dbaniu">
			...
			<input id="" name="" type="button" class="ydbz_s" value="下载" onclick="downloadJKD('${ctx}/visa/workflow/borrowmoney/downloadVisaBorrowMoney4XXZSheet?revid=${revid}&payId=${payId}&option=${option}');">
		</div>
		<script type="text/javascript">
