...
<body>
		...
		<div class="ydbz_tit">
			<span class="fl">借款批量审核</span><span class="fr wpr20">报批日期：${revCreateDate }&nbsp;&nbsp;批次：${batchno} </span>
      		</div>
      		<%-- <span class="fl">还款日期：<fmt:formatDate value="${refundDate }" pattern="yyyy-MM-dd"/></span>  --%>
		...
		<div style="margin-top:20px;"></div>
			...
			<form id="searchForm" action="${ctx}/visa/workflow/borrowmoney/batchReviewVisaBorrowMoneybyBatchNo" method="post">
					<!-- 添加提交请求所需数据 -->
					...
					<%-- <input type = "hidden"  id = "refundDate" name="refundDate" value = "${refundDate}"/> --%>
