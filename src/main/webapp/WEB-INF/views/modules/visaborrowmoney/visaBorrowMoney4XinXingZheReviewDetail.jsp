...
<script type="text/javascript">
	...
	function review(){
		...
		//alert("驳回");
		var html = '<div class="add_allactivity"><label>请填写审核备注信息!</label>';
		html += '<textarea style="width:80%; margin:10px auto;" name="reason" cols="" rows="" ></textarea>';
		html += '</div>';
...
<body>
	    ...
	    <!--右侧内容部分开始-->
		<div class="mod_nav">审核 > 新行者签证借款 > 新行者签证借款审批</div>
	...
	<form id="searchForm" action="${ctx}/visa/workflow/borrowmoney/review4XXZVisaBorrowMoney" method="post">
			<!-- 添加提交请求所需数据 -->
