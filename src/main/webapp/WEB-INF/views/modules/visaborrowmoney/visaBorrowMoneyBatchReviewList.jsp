...
<script type="text/javascript">
	$(function(){
		...
		//渠道改为可输入的select
		$("select[name='channel']").comboboxSingle();
...
<body>
			    ...
			    <div class="message_box">
            	 ...
            	 <!--右侧内容部分开始-->
                 <form id="searchForm" action="${ctx}/visa/workflow/borrowmoney/visaBorrowMoneyBatchReviewList" method="post">
