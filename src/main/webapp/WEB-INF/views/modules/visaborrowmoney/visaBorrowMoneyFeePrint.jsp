...
<script type="text/javascript">
	...
	function downloadJKD(url){
        ...
        $.ajax({ 
	          type:"POST",
	          url:g_context_url+"/visa/workflow/borrowmoney/visaBorrowMoneyFeePrintAjax",
	          dataType:"json",
	          data:dataparam,
...
<style type="text/css">
	...
	<body>
	    ...
	    <!-- 按钮的样式和位置坐了改动，放到借款单的下面 -->
	    <!--
		<input id="dayinDiv" name="dayinDiv" type="button" class="tab" value="打印" onclick="printTure();">
		<input id="dayinDiv" name="dayinDiv" type="button" class="tab" value="下载" onclick="downloadJKD('${ctx}/visa/workflow/borrowmoney/downloadVisaBorrowMoneySheet?revid=${revid}');">
		-->
		<!--
		...
		<div class="dbaniu">
			...
			<input id="" name="" type="button" class="ydbz_s" value="下载" onclick="downloadJKD('${ctx}/visa/workflow/borrowmoney/downloadVisaBorrowMoneySheet?revid=${revid}');">
		</div>
