...
<style type="text/css">
	...
	<body>
		...
		<div class="dbaniu">
			...
			<input id="" name="" type="button" class="ydbz_s" value="下载" onclick="downloadJKD('${ctx}/visa/workflow/borrowmoney/batchdownloadVisaBorrowMoneySheet?revid=${revid}&batchno=${batchno}&payId=${payId}&option=${option}');">
		</div>
