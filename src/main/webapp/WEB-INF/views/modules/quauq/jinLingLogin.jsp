...
<div class="page-cover">
	<!-- Cover Background -->
	<div class="cover-bg pos-abs full-size bg-img" data-image-src="${ctxStatic}/ljht/img/down_jinLing.png"></div>

	<!-- BEGIN OF Slideshow Background -->
	<div class="cover-bg pos-abs full-size slide-show">
		<i class='img' data-src='${ctxStatic}/ljht/img/up_jinLing.png'></i>
			...
			<div class="c-left">
				<div class="anim-slideleft">
					<div class="c-logo home-logo ">
						...
						<img src="${ctxStatic}/ljht/img/biaoyu_jinLing.png">
			...
			<div class="c-right">
				<div class="anim-slideright">
					<header class="header">
						...
						<img src="${ctxStatic}/ljht/img/logo_jinLing.png" style="width:50%; height:50%;">
						<h3 style="font-size:20px;">
							<!-- <span>北京辉腾国际旅行有限公司</span> -->
						</h3>
					</header>
					<!-- begin of forms -->
					<div id="jinling" class="form-wrapper desc">
						<form id="loginForm" class="message form send_message_form" method="post" autocomplete="off" action="${ctx}/login">
							...
							<c:if test="${isValidateCodeLogin}">
								<div class="validateCode clearfix">
									...
									<tags:validateCode name="validateCode"  inputCssStyle="margin-bottom:0;width:92px;border-radius:0;"/>
								</div>
							</c:if>
