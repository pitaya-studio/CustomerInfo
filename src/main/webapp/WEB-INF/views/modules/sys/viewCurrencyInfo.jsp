...
<div class="sysdiv sysdiv_coupon">
                    	...
                    	<p>
                            ...
                            <span>
                            <c:choose>
                            <c:when test="${currency.sort ==0 }">是</c:when>
                        ...
                        <p>
                            <label>汇率：</label>
                            <span>
                            <fmt:formatNumber value="${currency.currencyExchangerate}" type="NUMBER" maxFractionDigits="4"/>    
                            </span>
                        </p>
                    	<p>
                            <label>换汇汇率：</label>
                    	...
                    	<p>
                            <label>现金收款：</label>
                            <span>
                                <fmt:formatNumber value="${currency.convertCash}" type="NUMBER" maxFractionDigits="4"/> 
                            </span>
                        </p>
                    	<p>
                            <label>对公收款：</label>
                            <span>
                                <fmt:formatNumber value="${currency.convertForeign}" type="NUMBER" maxFractionDigits="4"/> 
                            </span>
                        </p>
                    	<p>
                            <label>中行折算价：</label>
                            <span>
                                <fmt:formatNumber value="${currency.convertAbc}" type="NUMBER" maxFractionDigits="4"/> 
                            </span>
                        </p>
                    	<p>
                            <label>最低汇率标准：</label>
                            <span>
                                <fmt:formatNumber value="${currency.convertLowest}" type="NUMBER" maxFractionDigits="4"/> 
                            </span>
                        </p>
                        <!--0365-qyl-begin  -->
                        <p>
                            <label>排序：</label>
                            <span>
                                <fmt:formatNumber value="${currency.sort}" type="NUMBER"/> 
                            </span>
                        </p>
                        <!--0365-qyl-begin  -->
                    </div>
