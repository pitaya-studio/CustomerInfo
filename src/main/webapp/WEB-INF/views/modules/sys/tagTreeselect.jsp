...
<body>
	<div style="position:absolute;right:28px;top:12px;cursor:pointer;" onclick="search();">
	...
	<div id="search" class="control-group hide" style="padding:10px 0 0 15px;">
		...
		<input type="text" class="empty" id="key" name="key" maxlength="50" style="width:140px;font-family: Verdana,Arial,Helvetica,AppleGothic,sans-serif;">
	</div>
	<div id="tree" class="ztree" style="padding:30px 20px;"></div>
</body>