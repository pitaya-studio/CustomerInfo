...
function show(uuid){
	window.open("${ctx}/activityHotel/show/" + uuid );
}
function edit(uuid){
	window.open( "${ctx}/activityHotel/edit/" + uuid );
}
function del(uuid){
	var ids = [];
	ids.push(uuid);
...
function v_deleteItems(ids){
	...
	$.jBox.confirm("确定要删除数据吗？", "系统提示", function(v, h, f) {
		if (v == 'ok') {
			...
			$.post( "${ctx}/activityHotel/delete", {"uuids":ids.join(",")}, 
				function(data){
					if(data.result=="1"){
...
function page(n,s){
	$("#pageNo").val(n);
	$("#pageSize").val(s);
	$("#searchForm").attr("action"," ${ctx}/activityHotel/list");
	$("#searchForm").submit();
}
</script>	
</head>
...
<!--右侧内容部分开始-->
   ...
   <form id="searchForm" modelAttribute="activityHotelQuery" action=" ${ctx}/activityHotel/list" method="post">
...
<input value="${activityHotelQuery.uuid}" id="uuid" name="uuid"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
产品编号,如SG0001：
</div>
<input value="${activityHotelQuery.activitySerNum}" id="activitySerNum" name="activitySerNum"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
酒店产品的名称：
</div>
<input value="${activityHotelQuery.activityName}" id="activityName" name="activityName"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
国家：
</div>
<input value="${activityHotelQuery.country}" id="country" name="country"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
海岛：
</div>
<input value="${activityHotelQuery.islandUuid}" id="islandUuid" name="islandUuid"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
酒店：
</div>
<input value="${activityHotelQuery.hotelUuid}" id="hotelUuid" name="hotelUuid"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
币种：
</div>
<input value="${activityHotelQuery.currencyId}" id="currencyId" name="currencyId"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
备注：
</div>
<input value="${activityHotelQuery.memo}" id="memo" name="memo"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
产品所属批发商的ID：
</div>
<input value="${activityHotelQuery.wholesalerId}" id="wholesalerId" name="wholesalerId"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
产品所属部门(创建者部门)：
</div>
<input value="${activityHotelQuery.deptId}" id="deptId" name="deptId"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
创建人：
</div>
<input value="${activityHotelQuery.createBy}" id="createBy" name="createBy"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
创建时间：
</div>
<input onclick="WdatePicker()" readonly value="<fmt:formatDate pattern="yyyy-MM-dd" value="${activityHotel.createDate}"/>" id="createDate" name="createDate"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
更新人：
</div>
<input value="${activityHotelQuery.updateBy}" id="updateBy" name="updateBy"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
更新时间：
</div>
<input onclick="WdatePicker()" readonly value="<fmt:formatDate pattern="yyyy-MM-dd" value="${activityHotel.updateDate}"/>" id="updateDate" name="updateDate"/>								</div>
								<div class="activitylist_bodyer_right_team_co1">
<div class="activitylist_team_co3_text">
0：正常；1：删除：
</div>
<input value="${activityHotelQuery.delFlag}" id="delFlag" name="delFlag"/>								</div>
	...
	<a class="btn btn-primary" href=" ${ctx}/activityHotel/form" target="_blank">添加</a>
</div>
