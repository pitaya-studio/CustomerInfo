...
<head>
	<title>基础信息维护-酒店房型管理-楼层详情</title>
...
<body>
	...
	<div class="maintain_add">
		<p>
			<label>名称：</label> <span> ${hotelFloor.floorName}</span>
		</p>
		<p class="maintain_kong"></p>
		<p>
			<label>排序：</label> <span> ${hotelFloor.sort}</span>
		</p>
		<p class="maintain_kong"></p>
		<p class="maintain_pfull">
			<label>描述：</label> <span> ${hotelFloor.description}</span>
		</p>
