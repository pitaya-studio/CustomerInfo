...
订单总额为：<span><i>${hotelOrder.totalMoney}</i></span>
</div>
	...
	<div id="offline_paybox" class="pay_clearfix" style="clear: both;"><!--去掉width=750-->
		...
		<div class="payORDER"
			...
			<div id="offlinebox_5" class="payDiv">
				<form id="offlineform_5" method="post" enctype="multipart/form-data" action="${ctx}/hotelOrder/modifypayVoucherFile" style="margin:0px; padding:0px;">
					<input type="hidden" name="orderUuid" value="${hotelOrder.uuid}">
		...
		<div class="ydbz_sxb ydbz_button">
			<a class="ydbz_s" href="${ctx}/hotelOrder/hotelOrderDetail/${hotelOrder.uuid}">查看订单</a>
