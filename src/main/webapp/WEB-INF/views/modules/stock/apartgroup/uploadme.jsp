...
function jumpto(){
    window.location.href="${ctx}/stock/manager/apartGroup/detail?id=${srcActivityId }&activityGroupId=${activityGroupId }";
}
...
<%--     <form:form id="inputForm" action="${ctx}/stock/manager/apartGroup/upload" enctype="multipart/form-data" method="post" onsubmit="return check();"> --%>
	<form:form id="inputForm" action="${ctx}/stock/manager/apartGroup/upload" enctype="multipart/form-data" method="post">
