...
订单总额为：<span><i>${productorder.totalMoney}</i></span><c:if test="${productorder.payStatus eq 1 or productorder.payStatus eq 2 }">&nbsp;&nbsp;&nbsp;<span><i>（尚未占位）</i></span></c:if>
</div>
	...
	<div id="offline_paybox" class="pay_clearfix" style="clear: both;"><!--去掉width=750-->
		...
		<div class="payORDER"
			...
			<div id="offlinebox_5" class="payDiv">
				<form id="offlineform_5" method="post" enctype="multipart/form-data" action="${ctx}/visa/order/modifypayVoucherFile" style="margin:0px; padding:0px;">
		...
		<div class="ydbz_sxb ydbz_button">
					<a class="ydbz_s" href="${ctx}/visa/order/goUpdateVisaOrder?visaOrderId=${orderId}&details=1" target="_blank">查看订单</a>
