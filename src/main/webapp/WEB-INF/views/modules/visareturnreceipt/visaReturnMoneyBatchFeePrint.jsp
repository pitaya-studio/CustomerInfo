...
<script type="text/javascript">
	...
	function downloadJKD(url){
        ...
        $.ajax({ 
	          type:"POST",
	          url:g_context_url+"/visa/workflow/returnreceipt/visaReturnMoneyBatchFeePrintAjax",
	          dataType:"json",
	          data:dataparam,
...
<style type="text/css">
	...
	<body>
		...
		<input id="dayinDiv" name="dayinDiv" type="button" class="tab" value="下载" onclick="downloadJKD('${ctx}/visa/workflow/returnreceipt/batchDownloadVisaReturnMoneySheet?revid=${revid}&batchno=${batchno}');">
		<!-- 
		...
		<div class="dbaniu">
		     ...
		     <input id="dayinDiv" name="dayinDiv" type="button" class="tab ydbz_s" value="下载" onclick="downloadJKD('${ctx}/visa/workflow/returnreceipt/batchDownloadVisaReturnMoneySheet?revid=${revid}&batchno=${batchno}');">
		</div>
