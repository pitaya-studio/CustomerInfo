...
$(function(){
	...
	$.ajax({    
	 				type: "POST",                 
					url:"${ctx}/order/manage/planeReview",                 
					data:{reason:'',travelerId:$("#trvalerId").val(),reviewId:$("#reviewId").val(),orderId:$("#orderId").val(),operate:1},                
	...
	html += '<textarea style="width:80%; margin:10px auto;" name="reason" id="reason" cols="" rows="" ></textarea>';
	html += '</div>';
...
<body>
	...
	<input id="orderId" type="hidden" value="${orderId}">
				...
				<!--右侧内容部分开始-->
				<div class="mod_nav">审核 > 改签申请 > 改签审批</div>
				...
				<div class="ydbz_tit">
					<span class="fl">游客改签</span><span class="fr wpr20">报批日期：${orderDetailInfoMap.travlerDetail.create_date} </span>
        		</div>
				<table id="contentTable" class="activitylist_bodyer_table">
				   ...
				   <tbody>
					  <tr>
                         ...
                         <td class="tc">${orderDetailInfoMap.travlerDetail.create_date}</td>
				...
				<div class="dbaniu">
					<a class="ydbz_s gray" onclick="closeCurWindow()">取消</a>
					 <a class="ydbz_s" id="back">驳回</a>
               		<a class="ydbz_s" id="submit">审核通过</a>
				</div>
