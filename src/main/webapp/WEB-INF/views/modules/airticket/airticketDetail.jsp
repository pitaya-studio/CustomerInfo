                ...
                <form id="modForm" action="/trekiz_wholesaler/a/activity/manager/modsave?proId=" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mod_information_dzhan">
						<div class="mod_information_dzhan_d mod_details2_d">
							...
							<c:if test="${flightInfo.number eq '1'}">去程</c:if>
							<c:if test="${flightInfo.number eq '2'}">返程</c:if>
							：</div>
...
<!--                              </tr> -->
                            ...
                            <div class="seach25 seach100 pro-marks1">
                              ...
                              <p class="seach_r" style="width:200px; white-space:nowrap; text-overflow:ellipsis; overflow:hidden;">
                              <span class="disabledshowspan" title="${airticket.remark}">${airticket.remark}</span></p>
                            </div>
                            <div class="kong"></div>
                         </div> 
                     </div>
                    ...
                    <div class="team_ins">
                          ...
                          <div class="mod_information_dzhan">
	                            <div class="mod_information_dzhan_d">
		                              ...
		                              <!-- <label>其他文件：</label>
		                              <label>
		                                  <img alt="" src="images/shangchuanbiaoqian_11.gif">
		                              </label>
		                              <label id="otherfile_file">新建 Microsoft Office Word 文档.docx</label>
		                              <a style="margin-left:10px;" href="javascript:void(0)" onclick="downloads(4435)">预览</a>
		                               -->
	                             </div>
                         </div>
                          <c:if test="${is_need_groupCode eq '1' }"><!-- 当批发商具有团号库权限时,才进行修改记录的展示  -->
                           <!-- 大洋87  机票产品团号修改记录，对应需求号 c451,c453 --><!-- C460 团号规则配置 -->
