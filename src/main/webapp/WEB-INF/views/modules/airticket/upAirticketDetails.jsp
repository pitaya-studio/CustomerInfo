	...
	<body>
		...
		<!--右侧内容部分开始-->
        	...
        	<!--币种模板结束-->
				...
				<form:form action="${ctx}/airTicketUpProces/applyForUpAirPrices" method="post" id="form1">
				...
				<div class="dbaniu" style="width:150px;">
					<a class="ydbz_s gray" href="${ctx}/airTicketUpProces/list?orderId=${orderId}&productType=${productType}&flowType=${flowType}">取消</a> 
