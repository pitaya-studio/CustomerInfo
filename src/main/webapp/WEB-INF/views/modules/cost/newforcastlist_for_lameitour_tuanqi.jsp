		...
		<div class="dayinzys">
			...
			<table width="700" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td align="center" class="text_normal bgcolorccc">单价</td>
					<td colspan="3" align="right" bgcolor="#FFFFFF" class="text_normal">¥${vo.price}</td>
				</tr>
			</table>
			<div style="margin-top: 1px">
				<table width="700" border="1" cellspacing="0" cellpadding="0" bgcolor="#cccccc" style="float:left;">
					<tr class="text_normal ie7shiying">
						<td align="center" bgcolor="#F5F5F5" class="text_normal bgcolorccc">预计收款</td>
					</tr>
					<tr>
			...
			<table width="700" border="0" cellspacing="0" cellpadding="0" bgcolor="#cccccc">
				<tr class="text_normal">
					...
					<td align="center" class=" bgcolorccc">预计退款合计</td> 注销by yudong.xu --%>
					<td align="center" class=" bgcolorccc">预计收入合计</td>
