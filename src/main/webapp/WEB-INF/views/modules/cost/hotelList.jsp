...
<!--   <div class="activitylist_bodyer_right_team_co_bgcolor">-->
	 <form:form id="searchForm" modelAttribute="activityHotelGroup" action="${ctx}/cost/island/hotel" method="post" >
     	 ...
     	 <div class="activitylist_bodyer_right_team_co3">
			<div class="activitylist_team_co3_text">批发商：</div>
      		...
      		<div class="activitylist_bodyer_right_team_co2">
				<label>出团日期：</label>
				<input id="groupOpenDate" class="inputTxt dateinput" name="groupOpenDate" value='<fmt:formatDate value="${activityHotelGroup.groupOpenDate }" pattern="yyyy-MM-dd"/>' style="margin-left: -3px; width: 122px;" onClick="WdatePicker()" readonly/> 
...
<div class="activitylist_bodyer_right_team_co_paixu">
		...
		<tbody>
			...
			<c:forEach items="${page.list}" var="activity" varStatus="s">
			 	<tr id="parent${s.count}">
                    ...
                    <td class="tc">
                    	<c:forEach items="${fn:split(activity.islandWay,';')}" var="var">
							<p>
                    ...
                    <td>   
                        <c:if test="${activity.status==1}">已上架</c:if>
  ...
  <a  target="_blank" href="${ctx}/cost/island/hotelDetail/${activity.activityHotelUuid}/${activity.uuid}/11?from=operatorPre">成本录入</a> 

  <a href="${ctx}/cost/manager/forcastList/${activity.uuid}/11" target="_blank">预报单</a>&nbsp;
  <a href="${ctx}/cost/manager/settleList/${activity.uuid}/11" target="_blank">结算单</a>                                
                            </dl>
                        </td>
             </tr>
