...
/*         var elemToCal = document.getElementById('operatorBudget');
    ...
    var eventHandler = function(mark, $Table){
        ...
        $("#operatorBudget").find("td[price-sum-bind='operatorBudget']").attr("class","tr");
        $("#operatorSpecific").find("td[price-sum-bind='operator']").attr("class","tr");
        $("#financeSpecific").find("td[price-sum-bind='finance']").attr("class","tr");
    };
