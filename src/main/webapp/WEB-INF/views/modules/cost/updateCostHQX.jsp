...
{   
  ...
  <body>
    <form:form name="frm" id="costForm" modelAttribute="sysdefinedict" action="${ctx}/cost/manager/updateHQX" target="_parent" method="post">
...
<div id="moneyId" style=" margin:10px;" >   
           ...
           <input name="account" id="account" type="text" value="${costRecord.bankAccount}"   style="width:180px"  />
            ...
            <td><input type="text" name="quantity"  id="quantity"  value="${costRecord.quantity}"  onkeyup="changeprice()" style="width:180px"/> 
            </td></tr> 
            ...
            <select style="width:75px; margin-right:5px;" id="currencyId" name="currencyId"  onchange="changeprice()">
                ...
                </select><input type="text" name="price"  id="price" oninput="changeprice()" value="${costRecord.price}"  style="width:100px"/>
             </td></tr>
           ...
           <tr><td align="right">转换后币种：</td><td>  RMB &nbsp;
            <select style="width:75px; margin-right:5px;;display:none" id="currencyAfter"  name="currencyAfter"  onchange="changeprice()">
                ...
                </select>&nbsp; 汇率：<input type="text" name="rate" id="rate" value="${costRecord.rate}"  onkeyup="changerate()" <c:if test="${fn:contains(companyName, '越柬行踪') }">readonly="readonly"</c:if> style="width:55px"/>
             </td></tr>
            ...
            <textarea rows="3" cols="20" id="comment" name="comment"  maxlength="1000" style="width:180px">${costRecord.comment}</textarea></td></tr>
           ...
           <tr><td colspan="2" align="center">
            <input class="btn btn-primary gray" type="button" value="取消" onClick="window.parent.window.jBox.close()"/>
             <c:if test="${costRecord.review==1 }">
              ...
              <c:if test="${ budgetType==0 && ( costRecord.review==4  ||  costRecord.review==0||  costRecord.review==5) }">
              ...
              <c:if test="${ budgetType==1 && ( costRecord.review==4  ||  costRecord.review==0||  costRecord.review==5||(costAutoPass==1 && costRecord.review==2&&(costRecord.payReview==0 ||   costRecord.payReview==4 ||costRecord.payReview==5 ))) }">
              ...
              <c:if test="${ budgetType==1 && costRecord.review!=1  && costRecord.review!=2 }">                
                <input  type="button"  class="btn btn-primary" onClick="submitForms( ${costRecord.review}, ${costRecord.payReview},${companyId})"  value="提交审核"/>
              </c:if>
