...
/*         var elemToCal = document.getElementById('operatorBudget');
        ...
        getCost('operatorBudget', $('#operatorBudget'), true);
                ...
                for(var i = 0; i < array.length; i++){
                    ...
                    if(editable){
                        if(array[i].directorRefused == 1){
                            htmldoc += '<td><span style="color:#eb0205;">（已拒绝）</span>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="modifyCost('+ array[i].id +', \'' + classType + '\')">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="return deleteCost('+array[i].id+', \'' + classType + '\');" class="button_delcb"></a></td></tr>';
                        }else if(array[i].directorRefused == 0){
                            htmldoc += '<td><span style="color:#3A7850;">（已通过）</span>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="modifyCost('+ array[i].id +', \'' + classType + '\')">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="return deleteCost('+array[i].id+', \'' + classType + '\');" class="button_delcb"></a></td></tr>';
                        }else{
...
/*                             if(tmp.length == 0){
    ...
    var save = function(){
        ...
        $.ajax({
            type: "POST",
            url: "${ctx}/cost/manager/flow/operatorFinanceRollback/save/" + groupId,
    ...
    var submit = function(){
        ...
        $.ajax({
            type: "POST",
            url: "${ctx}/cost/manager/flow/operatorFinanceRollback/commit/" + groupId,
            data : {types : "operator,operatorBudget"},
            async:false,
            success: function(e){
                if(e == "true"){
...
<!--                <tr class="toptr">
                    ...
                    <td>JHG140709013</td>
                    <td>管理员</td>
                    <td>2014-07-09 17:34:29</td>
                    <td>无</td>
                    <td><div class="tuanhao_cen onshow">23gffg</div>
                        <div class="chanpin_cen qtip" title="TEST-WYY0709-A-切位测试">
                            <a href="javascript:void(0)"
                                onclick="javascript:window.open('/a/activity/manager/detail2/955')">TEST-WYY0709-A-切位测试</a>
                        </div></td>
                    <td style="padding: 0px;"><div class="out-date">2014-08-15</div>
                        <div class="close-date">2014-08-12</div></td>
                    <td>1</td>
                    <td>已支付全款</td>
                    <td>¥<span style="font-size: 20px;"> 1,000 </span></td>
                    <td>¥<span style="color: #eb0301; font-size: 20px;">
                            1,000 </span></td>
                    <td>¥<span style="color: #3A7850; font-size: 20px;">
                            1,000 </span></td>
                    <td style="padding: 0px; background-color: #f3f3f3;"><div
                            class="huan">
                            <ul class="huan_title caption">
                                <li class="on">操作</li>
                                <li>付款</li>
                            </ul>
                            <div class="clear"></div>
                            <div class="huan_cen leven onshow">
                                <a href="javascript:void(0)"
                                    onclick="javascript:orderDetail(1245);">详情 </a> <a
                                    href="../showforModify?productorderById=1245" target="_blank">修改</a>
                            </div>
                            <div class="huan_cen leven">
                                <a href="javascript:void(0)"
                                    onclick="javascript:showOrderPay(1245,this);" class="jtk">支付记录</a>
                            </div>
                        </div></td>
                </tr> -->
            </tbody>
            ...
            <table id="operatorBudgetTable"
                ...
                <thead>
                    <tr>
                        ...
                        <th width="19%">金额</th>
                        <th width="25%">备注</th>
                        <th width="25%"><div class="button_addcb">
            ...
            <table id="operatorSpecificTable"
                ...
                <thead>
                    <tr>
                        ...
                        <th width="25%">备注</th>
                        <th width="25%"><div class="button_addcb">
                                操作<a onclick="addCost(this, 'operator',$('#operatorSpecific'))" class="button_addcb_a">添加项目</a>
                            </div></th>
                    </tr>
                </thead>
