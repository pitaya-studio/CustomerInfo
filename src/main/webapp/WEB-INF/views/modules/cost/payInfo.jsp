...
<html>
	<head>
		...
		<script type="text/javascript">
             // 打印
			function printTure(payId, prdType) {
				$.ajax({
			        type: "POST",
	...
	<body>
		...
		<!--S打印&下载按钮-->
		<div class="dbaniu">
			<input id="dayinDiv" name="dayinDiv" type="button" class="tab ydbz_s" value="打印" onclick="printTure(${data.payId},${data.prdType});">
			<input id="" name="" type="button" class="ydbz_s" value="下载" onclick="download(${data.payId},${data.prdType},'${data.printTime }');">
		</div>
	</body>
