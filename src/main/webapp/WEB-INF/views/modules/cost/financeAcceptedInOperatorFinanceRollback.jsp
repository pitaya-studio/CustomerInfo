...
/*                             if(tmp.length == 0){
    ...
    var save = function(){
        ...
        $.ajax({
            type: "POST",
            url: "${ctx}/cost/manager/flow/financeAcceptedInOperatorFinanceRollback/save/" + groupId,
    ...
    var submit = function(){
        ...
        $.ajax({
            type: "POST",
            url: "${ctx}/cost/manager/flow/financeAcceptedInOperatorFinanceRollback/commit/" + groupId,
            data : {types : "operator,finance"},
            async:false,
            success: function(e){
                if(e == "true"){
