...
<body>
	<form:form name="frm" id="costForm" modelAttribute="sysdefinedict"
		action="${ctx}/cost/island/saveIslandCost" target="_parent" method="post">
		...
		<br>
				...
				<table border="0" width="96%">
					...
					<tr style="height:35px;">
						...
						<td><input type="radio" name="supplyType" id="supplyType"
							value="0" checked onClick="tosupply()" />地接社 &nbsp;&nbsp; <input
							type="radio" name="supplyType" id="supplyType" value="1"
							onClick="tosales()" />渠道商</td>
					</tr>
								...
								style="width:180px">
									...
									<c:forEach var="agentinfo" items="${agentinfo }">
										<option value="${agentinfo.id }"
											<c:if test="${agentId==agentinfo.id}">selected="selected"</c:if>>${agentinfo.agentName}
										</option>
									</c:forEach>
							</select> </span></td>
					</tr>
					...
					<tr id="supply">
						...
						<td><span id="second"> <select id="supplier"
								name="supplier" onchange="selectbank()" style="width:180px">
					...
					<input type="hidden" name="quantity" id="quantity" value="1"
							onkeyup="changeprice()" style="width:180px" />
					...
					<tr>
						...
						<td>RMB &nbsp; <select
							...
							onkeyup="changerate()" style="width:98px" /></td>
					</tr>

					<tr>
						<td align="right">转换后总价：</td>
						<td><span id="costfinal"><input type="text"
								name="priceAfter" id="priceAfter" readonly style="width:180px" />
						</span></td>
					</tr>
					...
					<tr>
						...
						<td><textarea rows="3" cols="20" id="comment" name="comment"
								maxlength="1000" style="width:180px"></textarea>
						</td>
					</tr>
				</table>
			</div>
			...
			<div class="release_next_add">
				...
				<c:if
					test="${companyId !=68 || (companyId ==68  && budgetType == 2)}">
					<input type="button" class="btn btn-primary"
						onClick="this.disabled=true;submitForm('4')" id="save" value="提交" />
				</c:if>
				<!-- 
				<input type="button" class="btn btn-primary"
					onClick="this.disabled=true;submitForm('1')" id="saveto" value="提交审核" /> -->
			</div>
			</div>
	</form:form>
