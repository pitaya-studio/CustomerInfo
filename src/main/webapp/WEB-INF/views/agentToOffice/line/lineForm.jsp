...
//       */
    ...
    function save(){
    	 ...
    	 $.ajax({
    		 type:"post",
    		 url:"${ctx}/tourist/line/saveLine?token=${token}",
      ...
      function checkName(isModify, id){
    	  var checkName = false;
    	  var lineName = $("#label").val();
    	  var url;
    	  if (isModify) {
    	  	url = "${ctx}/tourist/line/checkLineName?id=" + id;
    	  } else {
    	  	url = "${ctx}/tourist/line/checkLineName";
    	  }
    ...
    <style type="text/css">
        ...
        /*bug 16736 quauqadmin-后台数据维护-新增游玩线路 ie8、9、10 样式错误*/
...
<body>
<form novalidate="novalidate" id="companyDictForm" action="${ctx }/tourist/line/saveLine" method="post" target="_parent">
    <div class="msg_div">
        <!-- <input id="value" name="value" value="" type="hidden"/> -->
        <input type="hidden" name="id" value="${id }" id="id"/>
        <p>
            <span class="widthQudao"><font>*</font>线路名称 ：</span>
            <input id="label" class="inputTxt" name="lineName" value="${lineName }" maxlength="30" type="text"  onblur="checklabel()" onfocus="goLabel()">
