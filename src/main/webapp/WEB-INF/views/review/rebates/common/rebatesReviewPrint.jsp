	...
	<body>
		...
		<div class="dbaniu">
		    <shiro:hasPermission name="rebatesReview:print:down">
				...
				<input id="" name="" type="button" class="ydbz_s" value="下载" onclick="downloadJKD('${ctx}/newRebatesReview/rebatesReviewDownload?reviewId=${map.reviewId}&payId=${map.payId}&groupCode=${map.groupCode}','${map.reviewId}');">
			</shiro:hasPermission>
		</div>
	</body>
</html>