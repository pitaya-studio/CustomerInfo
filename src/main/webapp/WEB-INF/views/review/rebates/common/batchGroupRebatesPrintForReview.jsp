...
<script type="text/javascript">
	...
	function updateTime(results){
		$.ajax({
	        type: "POST",
	        url: "${ctx}/newRebatesReview/batchUpdatePrintTime?results=" + results,
	        dataType:"json",
	        async:false,
	        cache:false,
	        data:{
	...
	<body>
		<div id="printDiv">
			<c:forEach items="${list }" var = "map">
				<c:if test="${map.reviewFlag  == 1 }">
					<c:choose>
						<c:when test="${(map.revstatus == '2' or map.revstatus == '3') and map.prdtype eq 6 }">
							<table class="dayinzy">
								<thead></thead>
								<thead>
									<tr>
										<th class="fr f4 paddr" colspan="8">首次打印日期：${map.printDate}</th>
									</tr>
									<tr>
										<th class="f1" colspan="8">支出凭单</th>
									</tr>
									<tr>
										<th class="fl paddl f3" colspan="4">填写日期： <fmt:formatDate pattern="yyyy 年 MM 月 dd 日" value="${map.revCreateDate}"/></th>
								...
								<tbody>
									...
									<tr>
										...
										<td class="f3" colspan="7">
											<div class="dayinzy_w698">项目备注：${map.remark};付款备注：${map.remark1}</div>
										</td>
									</tr>
									<tr>
										<td class="f2">收款单位</td>
										<td class="fl f3" colspan="7" >&nbsp;${map.orderCompanyName}&nbsp;&nbsp;${map.accountName} </td>
									</tr>
									<tr>
										<td class="f2">&nbsp;${currencyName}</td>
										<td class="f3" colspan="5" style="text-align:right;">&nbsp;${map.payRebatesAmount}</td>
										<td class="f2" >汇率</td>
									...
									<tr>
										...
										<td class="fc f3">￥</td>
										<td class="fl f3" colspan="2" style="text-align:right;">&nbsp;${map.rebatesAmount}</td>
									</tr>
									<tr>
							...
							<table  class="dayinzy  TopHeight">
									<tr>
									    ...
									    <c:if test="${map.payStatus == 0}">
									       <td class="fr f3 noborder paddr" colspan="8">确认付款日期：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日</td>
									    </c:if>
									    <c:if test="${map.payStatus == 1}">
									        <td class="fr f3 noborder paddr" colspan="8">确认付款日期：<fmt:formatDate pattern="yyyy 年 MM 月 dd 日" value="${map.revCreateDate}"/></td>
									    </c:if>
									</tr>
							</table>
							<div style="page-break-after: always;"></div>	
						</c:when>
						<c:when test="${(map.revstatus == '2' or map.revstatus == '3') and map.prdtype eq 7 }">
							<table class="dayinzy">
								<thead></thead>
								<thead>
									<tr>
							...
							<table    class="dayinzy  dayInIe">
								<tbody>
									...
									<tr>
										<td class="fc f2"><c:if test="${map.isYJXZ eq 'isYJXZ'}">实际</c:if> 领款人</td>
										<td class="fc f3">
											&nbsp;${map.payee}
										</td>
										<td class="fc f2">主管审批</td>
						...
						<c:when test="${(map.revstatus == '2' or map.revstatus == '3') and map.prdtype ne 6 and map.prdtype ne 7 and map.prdtype ne 11 and map.prdtype ne 12 }">
								<table class="dayinzy">
									<thead></thead>
									<thead>
										<tr>
				...
				<c:if test="${map.reviewFlag == 2 }">
					<c:choose>
						<c:when test="${(map.revstatus == '2' or map.revstatus == '3') and map.prdtype eq 6 }">
							...
							<table   class="dayinzy  dayInIe">
								<tbody>
									...
									<tr>
										<td class="f2">&nbsp;${map.currencyName}</td>
										<td class="f3" colspan="5" style="text-align:right;">&nbsp;${map.rebatesAmount}</td>
										<td class="f2" >汇率</td>
										<td class="f3">&nbsp;${map.currencyExchangerate}</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="fc f3">&nbsp;${map.reviewer}</td>
									</tr>
								</tbody>
							</table>
							<table  class="dayinzy  TopHeight">
						...
						<c:when test="${map.revstatus == '2' and map.prdtype ne 6 and map.prdtype ne 7 and map.prdtype ne 11 and map.prdtype ne 12 }">
							<table class="dayinzy">
							<thead></thead>
								<thead>
									<tr>
