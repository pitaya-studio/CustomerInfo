...
createDate：2015年12月11日12:29:28
 -->
...
<div id="sea">
	...
	<%@ include
		file="/WEB-INF/views/modules/order/rebates/rebatesBaseInfo.jsp"%>
	
	<div class="ydbz_tit">
		<span class="fl">游客退团</span><span class="fr wpr20">
			报批日期：<fmt:formatDate value="${reviewDetail.createDate }" pattern="yyyy-MM-dd HH:mm:ss" />
		</span>
	</div>
	<table id="contentTable" class="table activitylist_bodyer_table">
		...
		<tbody>
			<tr>
				...
				<td><fmt:formatDate value="${reviewDetail.orderTime }" type="both" /></td>
				<td class="tr"><span class="tdgreen">${reviewDetail.travelerPayPrice }</span></td>
				<td class="tr"><span class="tdgreen">${reviewDetail.afterString }</span></td>
				<td class="tr"><span class="tdgreen">${reviewDetail.refundString }</span></td>
