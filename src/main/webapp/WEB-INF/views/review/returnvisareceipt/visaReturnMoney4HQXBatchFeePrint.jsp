...
<script type="text/javascript">
	...
	function downloadJKD(url){
        ...
        $.ajax({ 
	          type:"POST",
	          url:g_context_url+"/visa/hqx/returnvisareceipt/visaReturnMoneyBatchFeePrintAjax4Activiti",
	          dataType:"json",
	          data:dataparam,
...
<style type="text/css">
	...
	<body>
		...
		<div class="dbaniu">
		     ...
		     <input id="dayinDiv" name="dayinDiv" type="button" class="tab ydbz_s" value="下载" onclick="downloadJKD('${ctx}/visa/hqx/returnvisareceipt/batchDownloadVisaReturnMoneySheet4Activiti?revid=${revid}&batchno=${batchno}');">
		</div>
