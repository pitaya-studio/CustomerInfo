                    	...
                    	<tr>
							...
							<c:choose>
							     <c:when test="${returnReviewInfo.isPrintFlag == '1'}">
							     		<td class="invoice_yes tc"><p class="uiPrint">已打印<span style="display: none;">首次打印日期<br><fmt:formatDate pattern="yyyy/MM/dd HH:mm" value="${returnReviewInfo.printTime}"/></span></p></td>
							     </c:when>
							     <c:otherwise>
							                <td class="tc">未打印</td>
							     </c:otherwise>
