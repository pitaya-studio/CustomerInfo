...
<body>
		...
		<div class="ydbz_tit">
			<span class="fl">还签证收据</span><span class="fr wpr20">报批日期：<fmt:formatDate value="${revCreateDate } pattern="yyyy-MM-dd HH:mm:ss"/></span>
      		</div>
		<table id="contentTable" class="activitylist_bodyer_table">
		   ...
		   <tbody>
			  <tr>
				 ...
				 <td class="tr">${revCurrency.currencyMark } 
				 
				 <fmt:formatNumber value="${revReceiptAmount }" pattern="###,##0.00" />
				 </td>
				 <td>${revReceiptor }</td>
