...
//		});
		...
		//搜索条件筛选
		launch();
		/*bug17611 modefied by ruiqi.zhang 2017-3-14 14:30:03*/
		//show('${flag}');
		...
		<input name="isTravellerList" id="isTravellerList" type="hidden">
                	...
                	<div class="activitylist_bodyer_right_team_co">
                    	<div class="activitylist_bodyer_right_team_co2 pr">
                        	<input class="txtPro inputTxt searchInput" value="${conditionsMap.orderCdGroupCdBatchNo }" flag="istips" name="orderCdGroupCdBatchNo" id="orderCdGroupCdBatchNo" placeholder="输入团号/产品名称"/>
                                ...
                                <dl class="handle">
                                    ...
                                    <p>
                                        ...
                                        <c:if test="${returnReviewInfo.status eq '1' and returnReviewInfo.isCurReviewer}">
                                        	<a href="${ctx}/visa/hqx/returnvisareceipt/visaReturnReceipt4HQXBatchReviewDetail?orderId=${returnReviewInfo.orderid}&travelerId=${returnReviewInfo.tid}&flag=0&revid=${returnReviewInfo.revid}&flowType=${returnReviewInfo.flowType}&batchno=${returnReviewInfo.batchNo}">审批</a>
                                        </c:if>
