...
//防止连续点击提交多条记录 
function visaChangePrice(){
	if(count<1){
		count = 1;
		new_check_visa_uppricess();
	}else{
		return;
	}
}
...
<!--右侧内容部分开始-->
               ...
               <div style="margin-top:20px;"></div>
				...
				<div class="dbaniu" style="width:150px;">
					<a href="javascript:history.go(-1);"  class="ydbz_s gray">取消</a>
					<input type="button" value="申请改价" class="btn btn-primary" onclick="visaChangePrice();">
				</div>
