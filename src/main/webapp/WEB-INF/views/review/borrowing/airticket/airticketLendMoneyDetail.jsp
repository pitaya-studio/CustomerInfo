...
<!-- 				<span style="padding-left:30px;">报批日期：</span><fmt:formatDate pattern="yyyy-MM-dd" value="${applyDate}"/> -->
				...
				<div class="ydbz_tit"><span class="fl">备注</span></div>
     			...
     			<dl class="gai-price-tex"><dd><textarea class="" rows="" cols="" id="borrowRemark" name="borrowRemark" readonly="readonly">${borrowRemark}</textarea></dd></dl>
...
<!--  
		...
		-->
			...
			<a class="ydbz_s gray" onclick="closeCurWindow()">关闭</a>
		<a href="${ctx}/activityOrder/lendmoney/borrowAmountList?flowType=19&productType=7&orderId=${orderId }" class="ydbz_s gray" >返回</a>
	</div>
