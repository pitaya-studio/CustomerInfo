    ...
    <script type="text/javascript">
        ...
        function downloadJKD(url){
            if("${printFormBean.printDate}" == '') {
                $.post("${ctx}/newOrderReview/manage/updateReviewPrintInfo", {"reviewId":"${reviewId}", "payId":"${payId}"},
                        function(data){
                            if(data != '') {
                                $("#printDate").text(data);
                            }
...
<div id="printDiv" class = "print_Div">
    ...
    <table  class="dayinzy  TopHeight">
        <tr>
            ...
            <c:if test="${printFormBean.payStatus == 0 }">
                <td class="fr f3 noborder paddr" colspan="8">确认付款日期：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日</td>
            </c:if>
            <c:if test="${printFormBean.payStatus == 1 }">
...
<div class="dbaniu">
    <shiro:hasPermission name="review:print:down">
        ...
        <input type="button" class="ydbz_s" value="下载" onclick="downloadJKD('${ctx}/newOrderReview/manage/downloadBorrowMoneySheet?reviewId=${reviewId}&orderType=${orderType}&payId=${payId}&option=${option}');">
    </shiro:hasPermission>
</div>
...
<script type="text/javascript">
    ...
    function printTure() {
        if("${printFormBean.printDate}" == '') {
            $.post("${ctx}/newOrderReview/manage/updateReviewPrintInfo", {"reviewId":"${reviewId}"},
                    function(data){
                        if(data != '') {
                            $("#printDate").text(data);
