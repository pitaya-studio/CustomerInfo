						...
						<!-- 无查询结果 --> 
							...
							<c:forEach items="${page.list}" var="reviewInfos">
								<tr>
									...
									<td class="tc">${reviewInfos.order_no}</td>
									
									<td>
									<div class="tuanhao_cen onshow">
										${reviewInfos.group_code}
									</div>
									...
									<td>${reviewInfos.agentName}</td>
									<td>
									<span class="order-saler onshow">${fns:getUserNameById(reviewInfos.saler)}</span><span class="order-picker"></span>
									</td>
									...
									<td>${fns:getUserNameById(reviewInfos.last_reviewer)}</td>
									<td>
									...
									<td class="p0">
										<dl class="handle">
											...
											<dd class="">
			                                    <p>
			                                        <span></span>
													<a href="javascript:viewReviewInfo('','${reviewInfos.order_id}','${reviewInfos.id}')">查看</a><br/>
													<a href="javascript:reviewBorrowing('','${reviewInfos.order_id}','${reviewInfos.id}')">审批</a>
													<!-- 审核撤销 -->
