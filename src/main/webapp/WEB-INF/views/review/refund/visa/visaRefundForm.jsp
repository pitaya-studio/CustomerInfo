	...
	if(wait==60){//防止重复提交多条记录 
		...
		if(validate.form()) {
			...
			$.ajax({
	            cache: true,
	            type: "POST",
	            url:"${ctx}/newRefund/visa/refundApply?proId=${param.proId}",
	            ...
	            success: function(data) {
	            	if( data!="success") {
	            		...
	            		window.location.href = "${ctx}/newRefund/visa/refundList?proId=${param.proId}";
	            	}
	            }
	        });
		}
...
<!-- 				 </div> -->
	             ...
	             <div class="ydBtn ydBtn2">
	             	 <c:if test="${!empty travelerList}">
	             		<input class="ydbz_x" type="button" onClick="subForm()" value="提交" id="save"/>
	             	 </c:if>
