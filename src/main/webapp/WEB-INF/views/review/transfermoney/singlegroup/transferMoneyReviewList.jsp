...
// 								$.jBox.tip("批量审批结束！存在失败的审批，详情：" + result.message, "error");
							...
							//刷新页面
							window.location.href="${ctx}/singlegrouporder/transfermoney/transferMoneyReviewList/REVIEW";
						}
		            })
	            }
...
<body>
	<div id="sea">
	<!--右侧内容部分开始-->			
	     	<form id="searchForm" action="${ctx}/singlegrouporder/transfermoney/transferMoneyReviewList/REVIEW"  method="post">
	     		<!-- 角色 -->
				    ...
				    <!-- 搜索 -->
	                	...
	                	<div class="activitylist_bodyer_right_team_co">
							<div class="activitylist_bodyer_right_team_co2 pr">
								<input class="txtPro inputTxt searchInput" value="${conditionsMap.orderCdGroupCdProductNm }" placeholder="请输入团号/产品名称/订单号" name="orderCdGroupCdProductNm" id="orderCdGroupCdProductNm"/>
							</div>
							<a class="zksx">筛选</a>
							<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}" />
							...
							<div class="ydxbd min-screen text-more-new">
								<!-- 筛选条件第1行 -->
