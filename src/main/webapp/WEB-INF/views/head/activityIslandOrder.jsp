...
<li <c:if test="${showType==1}">class="active current"</c:if>><a href="${ctx}/islandOrder/orderIslandList?showType=1&status=0">团期列表</a></li>
<li <c:if test="${showType==2}">class="active current"</c:if>><a href="${ctx}/islandOrder/orderIslandList?showType=2&status=0">产品列表</a></li>
</ul>
	<%--
