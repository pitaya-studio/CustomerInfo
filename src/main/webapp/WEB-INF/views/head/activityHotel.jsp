...
<li <c:if test="${showType==1}">class="active current"</c:if>><a href="${ctx}/activityHotel/activityHotelList?status=0&showType=1">团期列表</a></li>
<li <c:if test="${showType==2}">class="active current"</c:if>><a href="${ctx}/activityHotel/activityHotelList?status=0&showType=2">产品列表</a></li>
</ul>
	<%--
