...
<div class="input-append">
	...
	<input id="${id}Name" name="${labelName}" readonly="readonly" type="text" value="${labelValue}"
		   class="${cssClass}" style="${cssStyle}"/><a id="${id}Button" href="javascript:" class="btn ${disabled}" style="_padding-top:6px;">&nbsp;选择&nbsp;</a>
</div>
<script type="text/javascript">
	$("#${id}Button").click(function(){
		...
		// 正常打开	
		top.$.jBox.open("iframe:${ctx}/tag/treeselect?url="+encodeURIComponent("${url}")+"&module=${module}&checked=${checked}&extId=${extId}&selectIds="+$("#${id}Id").val(), "选择${title}", 320, 420,{
