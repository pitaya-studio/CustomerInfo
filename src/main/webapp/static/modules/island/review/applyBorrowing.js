...
function submitRefund(){
	   totallend();
		   ...
		   $.ajax({
			   type: "POST",
				  url: g_context_url + "/island/review/saveBorrowing",
				  dataType: "text",
				  data : $("#f1").serialize(),
				  async: false,
				  success:function(msg){
					  top.$.jBox.tip(msg, 'warnning');
					  document.location = g_context_url + "/island/review/viewBorrowingList?flowType=19&productType="+$("#myOrderType").val()+"&orderId=" + orderId+"&orderUuid="+$("#orderUuid").val();
				  }
		   	});  
}
