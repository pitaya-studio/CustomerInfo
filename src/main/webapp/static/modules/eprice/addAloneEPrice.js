...
//					$(nexts).find("option:lt("+i+")").hide();
			...
			//	var travelCountryId = $("#eprice-b-form-id select[name=travelCountryId]").val();//线路国家id
					...
					"afterInvalid":function(event,data){
						...
						if(-1 == $.inArray(data,Array_default)){
							...
							if(isIncluded){
								...
								$("#vendorOperatorShow").append('<a style="padding:0px 20px 0px 15px;position:relative; ">{0}<input type="hidden" name="aoperatorUserId" value="{1}" /><span style="position:absolute;right:3px;top:4px;cursor: pointer;" class="deleteicon" href="javascript:void(0)" onclick="deleteSelected(this)">x</span></a>'
										.replace("{0}",data).replace("{1}",selectValue));
							}
						}
					}
				});
					...
					"afterInvalid":function(event,data){
						...
						if(-1 == $.inArray(data,Array_default)){
							...
							if(isIncluded){
								...
								//$("#countryShow").append('<input type="hidden" name="travelCountryId" value="{0}"/>'.replace("{0}",selectValue));
								//$("#countryShow").append('<input type="hidden" name="travelCountry" value="{0}"/>'.replace("{0}",data));
							}
						}
					}
				});
					...
					"afterInvalid":function(event,data){
						...
						if(-1 == $.inArray(data,Array_default)){
							...
							if(isIncluded){
								...
								$("#ticketOperatorShow").append('<a style="padding:0px 20px 0px 15px;position:relative; ">{0}<input type="hidden" name="toperatorUserId" value="{0}"/><input type="hidden" name="travelCountry" value="{2}"/><span style="position:absolute;right:3px;top:4px;cursor: pointer;" class="deleteicon" href="javascript:void(0)" onclick="deleteSelected(this)">x</span></a>'
