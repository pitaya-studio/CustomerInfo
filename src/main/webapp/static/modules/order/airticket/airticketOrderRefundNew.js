function bind(){
  $("#bt_cancel").click(function(){
     ...
     document.location = g_context_url + "/order/refundNew/viewListNew?orderId=" + orderId;
  });
...
function submitRefund(){
   ...
   $.ajax({
	   type: "POST",
		  url: g_context_url + "/order/refundNew/refundApplyCheck",
		  dataType: "json",
		  data : postData,
		  async: false,
		  success:function(msg){
			  if(msg.result=='0'){
				  $.ajax({
					   type: "POST",
						  url: g_context_url + "/order/refundNew/submitReviewNew",
						  dataType: "json",
						  data : postData,
						  async: false,
						  success:function(msg){
...
function loadCurrency(){
   $.ajax({
		  type: "GET",
		  url: g_context_url + "/order/refundNew/currencyJson",
		  dataType: "json",
		  async: false,
		  success:function(msg){
