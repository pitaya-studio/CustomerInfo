		...
		if(v=='ok'){
			...
			if(values==""){
				...
				if(checkFlag==0){
					$.ajax({
	                type: "POST",
	                url: contextPath+"/orderReceipt/manage/getOrderOpenReceiptInfo",
	                data: {
...
function addSingleOrderInvoiceInfo(obj,msg){
	...
	var html='<div class="invoicediv">';
                        ...
                        html+='<td class="mod_details2_d1_five">已开收据：</td>';
                        ...
                        html+='<th width="10%">已开收据金额</th>';
                        html+='<th width="10%">未开收据金额</th>';
                        html+='<th width="10%">本次开收据金额</th>';
                        html+='</tr>';
                        html+=' </thead>';
                        html+='<tbody>';
                        html+=' <tr>';
