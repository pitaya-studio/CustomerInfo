	(function($) {
		...
		$.suggest = function(input, options) {
			...
			if($.trim($input.val())=='' || $.trim($input.val())=='中文/拼音') $input.val('中文/拼音').css('color','#000');
			...
			function resetPosition() {
				...
				$results.css({
					...
					left: offset.left + 'px'
//					top:($input[0].offsetTop + input.offsetHeight) + 'px',
...
//						html+='<li rel="'+options.hot_list[h][0]+'"><a href="#'+h+'"><span>'+options.hot_list[h][2]+'</span>'+options.hot_list[h][1]+'</a></li>';
						html+='<li rel="'+options.hot_list[h][0]+'" style="text-align:left"><a href="#'+h+'"><span> </span>'+options.hot_list[h][1]+'</a></li>';
					}
...
//							html += '<li rel="' + options.source[i][0] + '"><a href="#' + i + '"><span>' + options.source[i][2] + '</span>' + options.source[i][1] + '</a></li>';
							html += '<li rel="' + options.source[i][0] + '" style="text-align:left"><a href="#' + i + '"><span> </span>' + options.source[i][1] + '</a></li>';
						}
					}
					if (html == '') {
