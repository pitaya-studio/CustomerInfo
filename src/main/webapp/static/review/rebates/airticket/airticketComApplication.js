...
function submitRefund(){
	   ...
	   $.ajax({
		   type: "POST",
		   url: g_context_url + "/order/lendmoney/LendMoneyApply",
		   dataType: "text",
		   data : $("#f1").serialize(),
		   async: false,
		   success:function(msg){
			   alert(msg);
			   document.location = g_context_url + "/order/lendmoney/borrowAmountList?flowType=19&productType=7&orderId=" + orderId;
		   }
	   });
}
