...
function cancel(orderId){
	window.location.href=contextPath+"/singlegrouporder/transfermoney/transfersMoneyApplyList/"+orderId;
}
...
function submitForm(){
	if(reviewSign == 0){
		...
		$.ajax({
			type : "POST",
			url : contextPath+"/singlegrouporder/transfermoney/transfersMoneyApply",
			...
			success : function(html){
				...
				if(json.res=="success"){
					...
					window.location.href=contextPath+"/singlegrouporder/transfermoney/transfersMoneyApplyList/"+$("#myOrderId").val();
