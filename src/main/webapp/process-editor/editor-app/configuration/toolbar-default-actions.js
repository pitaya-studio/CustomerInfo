...
var SaveModelCtrl = [ '$rootScope', '$scope', '$http', '$route', '$location','urlParam',
    function ($rootScope, $scope, $http, $route, $location,urlParam) {

    var modelMetaData = $scope.editor.getModelMetaData();
        modelMetaData.processKey=urlParam().processKey;
        modelMetaData.serialNumber=urlParam().serialNumber;
    ...
    $scope.saveAndReturn = function(){
        $scope.save(function(){
            window.location.href =ACTIVITI.CONFIGC.contextRootC+"/sys/review/configuration/detail?serialNumber="+urlParam().serialNumber;
        });
    };
    ...
    $scope.save = function (successCallback) {
        ...
        $http({    method: 'PUT',
            ...
            url: KISBPM.URL.putModel(modelMetaData.modelId,modelMetaData.processKey,modelMetaData.serialNumber)})
