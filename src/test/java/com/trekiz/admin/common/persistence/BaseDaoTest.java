...
//import com.trekiz.admin.modules.lucene.repository.IndexDao;
...
//			System.out.print(o.getName()+", "+o.getCompany().getName()+"\n");
//		}
//		
...
//		
//		List<Activity> res = indexDao.findActivityList();
//		for(Activity ac:res){
//			System.out.println(ac.getActivity_name());
//		}
//	}
//	
//}